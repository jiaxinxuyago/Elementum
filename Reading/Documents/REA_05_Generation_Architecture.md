...
| `Elementum_App/tools/voice-audit.mjs` | **The REA_16 mechanical tone audit** (added 2026-08-05): greps STEM station content (inscription / yourNature_desc / dm_overview) for dashes, semicolons, glyphs, negative parallelism, banned AI-cluster vocabulary, "room" rationing, budgets, You-opener + energy-subject laws, and cross-stem 4-gram scaffold repeats. `VOICE` line per violation, exit 1. The human half (swap test, angle fidelity, read-aloud) stays human. |
