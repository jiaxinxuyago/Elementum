...
| `dm_overview` | paragraph + trait rows | STEM ×10 | — | para ≤50w + 3 rows (Decides · Relates · Under pressure) ≤12w each · **register: ANALYST'S LEDGER** (§10 rule 12) | *(new variable, owner-commissioned 2026-08-05 — candidates in the tone lab)* | P4 Day-Master screen | PLANNED (tone lab) |
...
12. **THE VOICE (owner-ratified 2026-08-05, "the engraving that reads you" — full authoring prompt: BIZ_03 §8):** never conversational — an artifact older than the reader. Manifesto = mythic frame (L1 noun-led hierarchy claim 2–4w; L2 ≤9w third-person element-as-image, element never named; format breaks only in-character). Inscription = recognition engine (beat-1 names the MECHANISM not the trait; beat-2 names the specific, private, unwitnessed COST — descriptive, never instruction/prediction/doom). Bans: hedging, flattery-without-cost, colloquialism, imperatives, therapy jargon. Litmus ×3: screenshotable as self-description · trusted as a system · no wince from the heritage reader. **Register spectrum (ruled 2026-08-05, BIZ_03 §8b):** one voice, three registers — THE ENGRAVING (identity; imperatives banned) · THE ANALYST'S LEDGER (chart analysis, e.g. `dm_overview`) · THE ALMANAC (daily guidance; instructive allowed). Every variable declares its register.
