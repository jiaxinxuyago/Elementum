...
| `gifts` (tagged pool) | phrase + desc ×5 | STEM + band tags | phrase 2–3w situational | **TAGGED-POOL construct (owner-ratified 2026-08-05; dimension law v3 + REGISTER SPLIT/phrase law v4 2026-08-14):** 5 items/stem, station `{phrase, dim, desc, bands}` → code `{phrase, desc, bands}`. **phrase = the trait STAGED (situational register, 2–3 everyday words w/ noun/verb anchor — the label register belongs to `stem_keywords`; no keyword root-share, audit-enforced) · `dim` = solely the ANGLE (life-facet lens, station-side, unique per pool, ≠ phrase) · desc = the trait seen through that angle.** `selectPoolByBand` picks ×3 per chart band (band-tagged first, all-tagged in pool order); REA_16 §3 pool laws | Crisis performer `dim: under pressure` The day everything breaks is the day you're calmest… `bands:[concentrated]` | P4 Gifts & Shadows panel + d12 Elemental Nature detail | **LIVE · pools LOCKED ×10 (owner; register split 2026-08-14)** |
| `shadows` (tagged pool) | phrase + desc ×5 | STEM + band tags | phrase 2–3w situational | same construct, symmetric with `gifts` (owner: if one varies, both vary) | Endless second-guessing `dim: decision-making` You reach an answer, then reopen it… `bands:[open]` | P4 Gifts & Shadows panel + d12 Elemental Nature detail | **LIVE · pools LOCKED ×10 (owner; register split 2026-08-14)** |
