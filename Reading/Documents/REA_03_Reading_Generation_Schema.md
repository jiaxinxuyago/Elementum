...
| **The distillation ladder** (derived surfaces ×3): catalogue takeaway strip (pattern line + deep-seat line, both deep-linked) · dot-card deep-seat hint · two-stage seat disclosure | derived one-liners + staging | DERIVED (SLOT_RANK ranking + firstSentence over locked corpus: TG_PATTERN.reading, POSITION.teaser) | first sentences | **DES_04 §AM.11 (owner rulings 2026-08-19): six-rung cognitive-load law — every level shows a derived distillation of the level below; ranking law REA_02 §5e; NO new authored content** | catalogue: "One law runs underneath your money: it attracts company." → taps into the Wealth seat | catalogue beat 1 · dot card · seat accordions | LIVE (wired 2026-08-19) |
