...
| `yourNature_desc` (baseline ×10; ×150 K1 variants exist) | paragraph | STEM (→ STEM·BAND·PATTERN) | 38–50w (locked corpus) | ≥2 sentences — **propose ≤50w** (R4) · You-opener + Angle Map + humanize gate (REA_16) | You put the truth ahead of your own comfort, and usually ahead of your own company. … | P4 "Your nature" section (wired 2026-08-05 — baseline direct; band-resolution returns at R4) | **baseline LOCKED ×10 + SURFACING on P4** ⚠ R4 = variants re-author + band resolution + dead J4 sub-screen fate |
