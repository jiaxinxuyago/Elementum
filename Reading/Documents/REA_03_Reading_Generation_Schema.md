...
| `dm_overview` | paragraph | STEM ×10 | — | pure paragraph 60–80w (trait rows dropped, owner re-ruled 2026-08-05) · **register: ANALYST'S LEDGER** + humanized-prose gate (§10 rule 12) | *(new variable, owner-commissioned 2026-08-05 — candidates in the tone lab)* | P4 Day-Master screen | PLANNED (tone lab) |
