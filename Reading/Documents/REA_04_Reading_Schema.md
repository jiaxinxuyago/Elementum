...
**Derives from:** D13 wireframe v5 (`Design/Wireframes/d13-five-energies-journey.html` — word budgets are LAW) · `REA_07_Reading_Concept_Inventory.md` Parts 1–3 · REA_01 (archetype structure) · the Profile Database (`Reading/Database/elementum_profile_database.html`).
