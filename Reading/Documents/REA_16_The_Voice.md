...
| `station:ELEMENT_GOD.k2_overview` | portrait | 45-70w | pending | K2 cell lead (土_偏印 template authored 2026-08-19, awaiting owner lock) |
| `station:ELEMENT_GOD.k2_functional` | portrait | ≤22w each ×5 | pending | Mind · Expression · Bonds · Action · Body (owner-ruled set) |
| `station:ELEMENT_GOD.k2_domain_readings` | portrait | 30-55w each | pending | one per the god's ruled domains; Seeker-gated in the view |
