...
| `station:POSITION.defline` | carved | ≤25w | pending | the named event's first-surfacing line (template = pianyin_month_branch) |
| `station:POSITION.reading` | portrait | 60-95w | pending | opens by DECLARING its ruled domains from the canonical taxonomy ×8 |
| `station:POSITION.domains` | functional | — | pending | 2–3 of: Wealth · Health · Career · Love · Family · Social · Mind · Growth |
