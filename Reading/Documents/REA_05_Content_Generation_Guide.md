# REA_05 — Content Generation Guide
...
> The *shape* of every field (type, tier, word caps, `varyBy` cardinality) is declared canonically in [`Elementum_App/src/contract/archetypeSchema.js`](../../Elementum_App/src/contract/archetypeSchema.js). The UI-surface companion is [REA_14 — Reading Generation Schema](REA_14_Reading_Generation_Schema.md).
