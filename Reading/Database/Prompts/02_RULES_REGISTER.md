...
| B2 | Sentence lengths span a threefold range inside a paragraph; one ordinary, unquotable sentence per paragraph | REA_16 §1b, §4 | read | explicit |
...
| B4 | Plain Anglo-Saxon verbs; "is" stays "is"; concrete nouns over abstractions; one idea may stay unresolved; fragments ≤1 per door passage | REA_16 §1b, §4; §2c THE THREE DOORS | read | explicit |
| B5 | Endings vary; never three tied bows in a row | REA_16 §4 | read | explicit |
...
| C3 | Every field keeps its budget (the card's word or character count); openers where the card demands one ("You", the archetype name, "Run thin," / "Run heavy,", "This position rules", the definition formula, "Your {Element}") | REA_16 §2c budgets; the field cards | harness · voice-audit (budgets) | explicit |
