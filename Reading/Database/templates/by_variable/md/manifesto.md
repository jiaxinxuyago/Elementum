# `manifesto`  ·  by-variable comparison
...
| Archetype | Key | Value |
|---|---|---|
| **The Oak** | 甲 | Motion before readiness · The oak does not negotiate its direction. |
| **The Vine** | 乙 | Route bends. Destination holds. · The vine finds every wall a ladder. |
