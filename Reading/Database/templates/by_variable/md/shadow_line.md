# `shadow_line`  ·  by-variable comparison
...
| **The Twin at the Month Gate** | 比肩在月干 | Overloaded, the equal becomes the rival everywhere: every meeting a quiet arm-wrestle. |
...
| **The Rival inside the Hour Gate** | 劫财在时支 | Overloaded, generosity becomes the last contest: giving as the final way to win. |
| **The Artisan at the Year Gate** | 食神在年干 | *(unauthored)* |
| **The Artisan inside the Year Gate** | 食神在年支 | Overloaded, this root drifts: sweetness used as sedative, the couch quietly winning years. |
...
| **The Horizon inside the Day Gate** | 偏财在日支 | Overloaded, charm at close range turns transactional: affection priced without anyone naming it. |
| **The Horizon at the Hour Gate** | 偏财在时干 | *(unauthored)* |
| **The Horizon inside the Hour Gate** | 偏财在时支 | *(unauthored)* |
| **The Steward at the Year Gate** | 正财在年干 | Overloaded, prudence turns miserly here: joy postponed for a rainy day that never gets invited. |
...
| **The Steward at the Hour Gate** | 正财在时干 | Overloaded, the estate outranks the evenings: comfort deferred in the very years built for it. |
...
| **The Alchemist inside the Month Gate** | 偏印在月支 | Overloaded, insight sours into suspicion: reading motives where there is only weather. |
