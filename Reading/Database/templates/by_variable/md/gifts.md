...
| `2.bands` | concentrated |
| `3.phrase` | Unforgettable listener |
| `3.dim` | people |
| `3.desc` | People come back years later still talking about a conversation you barely remember. Being truly heard by you left a mark. |
| `3.bands` | balanced · open |
...
| `0.bands` | all |
| `1.phrase` | Thinks in layers |
| `1.dim` | depth |
| `1.desc` | Your first answer already considered the five objections nobody's raised yet. People sense the depth before they can name it. |
| `1.bands` | all |
| `2.phrase` | Thinks big |
| `2.dim` | scope |
