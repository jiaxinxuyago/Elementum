# `k2_domain_readings`  ·  by-variable comparison
...
| `Nurture` | The nourishing thread runs steel-true. Where care came early, you draw on it without thinking. Where it was missing, you set your own standard. Keep the precision, soften the grading. |
...
| `Nurture` | The nourishing thread is bedrock here. Where care came early, you draw on it without thinking. Where it was missing, you became the ground yourself. Keep one plot for you. |
...
| `Father` | The father-thread runs green and rangy: reach, enterprise, restlessness, wherever a paternal figure stood. Where that reaching shaped you, keep it. Where it left no roots, plant them yourself. |
...
| `Nurture` | The nourishing thread runs orchard-deep. Where care came early, you draw on it without thinking. Where it ran thin, you grew your own. Tend your roots with the same hands you use on everyone else’s. |
...
| `Nurture` | The nourishing thread glows in you. Where care came early, you draw on it without thinking. Where the hearth was cold, you lit your own. Let someone tend you for once. |
