...
|---|---|
| `primary` | action |
| `definition_catalyst` | Wood is your Action, and as a catalyst, it is where your discipline becomes results: projects, ventures, skills that grow with tending. You do best with one live build that rewards steady work, and worst with none.  Day to day this looks like being calmer on busy weeks than on empty ones, feeling most yourself with a work in progress, and losing steam the moment nothing depends on you. Idleness reads to you as unease.  The program: keep a single main project at all times, and give it the first hour of your day, before anyone else gets you. Review it weekly, and when it ends, start the next one within a month. |
| `definition_friction` | Wood is your Action, and as a friction, it is too many builds drawing on too little fuel: every open project takes a daily cut of attention whether you touch it or not. Progress spreads thin across all of them.  Day to day this looks like a long list of half-done things, guilt attached to each one, and the strange fact that adding a new project feels easier than finishing an old one. Momentum keeps restarting from zero.  The program: list everything you have started, finish or close the bottom half, and let one thing get your best. Adopt a one-in, one-out rule for new commitments. Measure your week by what you completed, never by what you began. |
...
|---|---|
| `primary` | order |
| `definition_catalyst` | Fire is your Order, and as a catalyst, it is the pressure that organizes you: deadlines, scrutiny, real stakes. You focus best when something is genuinely on the line, and drift when nothing is.  Day to day this looks like finishing more in the last two days than in the quiet two weeks before, working better with a witness, and going slack the moment a deadline moves. Low-stakes seasons quietly cost you the most.  The program: keep one commitment with external accountability at all times, a client, a coach, a date you cannot move. Break long projects into short public checkpoints. When motivation dips, add stakes before you add effort. |
| `definition_friction` | Fire is your Order, and as a friction, it is pressure landing on reserves that are already low: every demand feels urgent, so you answer all of them and recover from none.  Day to day this looks like a calendar full of other people’s emergencies, a jaw that will not unclench, and standards you keep meeting at costs nobody sees. Saying no feels more dangerous than being drained does.  The program: pick the two obligations that actually pay you back, and practice saying a slow no to the rest. Build one pressure-free hour into every day. Before accepting a new demand, name what it will replace. |
...
|---|---|
| `primary` | body |
| `definition_catalyst` | Metal is your Body, and running thin, it is the reserve everything else draws on: sleep, food, recovery, the physical base under your discipline. Yours holds form long after the fuel is low, so you notice depletion late.  Day to day this looks like powering through on standards instead of strength, colds that arrive the moment a push ends, and pride in needing less than other people. The crash always comes after the deadline, never before it.  The program: put maintenance on the calendar before you need it, a fixed bedtime, real meals, one full rest day a week. Track energy like money for a month. Treat the first sign of wear as the warning, never as the baseline. |
| `definition_friction` | Metal is your Body, and running over, it is more physical force than your life currently spends: discipline with no outlet, stamina turning into tension you carry in your shoulders and jaw.  Day to day this looks like restlessness at rest, workouts that calm you more than vacations do, and a body that braces for effort even on quiet days. Unused strength shows up as irritation first, and sleep only fully arrives after real exertion.  The program: give it a hard weekly outlet, lifting, long walks, manual work, and watch the tension drop. Pair every sitting-heavy day with something physical. When your patience shortens, train before you talk. |
