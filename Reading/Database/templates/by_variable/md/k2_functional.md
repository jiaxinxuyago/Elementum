...
| `bonds` | You bond shoulder to shoulder: respect first, warmth after. Equals stay for decades. Leaners slide off. |
...
| `bonds` | You respect opponents into friends. The people closest to you have all crossed blades with you once. |
...
| `bonds` | You care for people through made and mended things. Love, from you, has clean joins. |
...
| `bonds` | You bond through sharpened banter. Those who can parry stay. Those who bleed easily should not spar. |
...
| `bonds` | Your circle is a mint of contacts: precise relationships, mutual value, genuine respect. |
...
| `bonds` | You keep people the way you keep good tools: carefully, long, with respect. |
...
| `bonds` | You respect chains of trust: loyalty earned in pressure, kept for life. |
...
| `bonds` | You keep relationships in good order: defined roles, honored obligations. |
...
| `bonds` | You bond selectively: few people, assayed deeply, kept like fine tools. |
...
| `bonds` | You protect by strengthening: your people leave your care harder to break. |
...
| `bonds` | You keep steady company at arm’s length plus a handshake: loyal, present, boundaried. |
...
| `bonds` | You bond over building something contested: ventures, renovations, shared bets on shared ground. |
...
| `bonds` | People settle into your care like a kitchen chair: fed, warmed, reluctant to leave. |
...
| `bonds` | You impress slowly and permanently. People underestimate you once each. |
...
| `bonds` | Your network is landed: durable relationships with assets and addresses. |
...
| `bonds` | You hold people with land-deep loyalty: slow to accept, never letting go. |
...
| `bonds` | You protect like a fortress: those inside your walls are safe and know it. |
...
| `bonds` | You anchor your people: the steady one every crisis phones first. |
...
| `bonds` | You are the ground floor of your people: permanent, load-bearing, home. |
...
| `bonds` | You grow alongside people rather than around them: parallel lives, mutual respect, roots politely separate. |
...
| `bonds` | You grow closest to people you compete with: siblings in spirit, rivals in season. |
...
| `bonds` | You feed your people literally and figuratively, and watch them grow with a farmer’s pride. |
...
| `bonds` | You draw people who love wildness and alarm people who prune. Both are correct. |
...
| `bonds` | You network like a forest: connections spreading underground, favors flowering seasons later. |
...
| `bonds` | You invest in people long-term and harvest loyalty at maturity. |
...
| `bonds` | You lead your grove protectively: front position, weather taken first. |
...
| `bonds` | You hold relationships upright: clear expectations that people grow along. |
...
| `bonds` | You connect through shared curiosity: fellow gardeners of odd ideas. |
...
| `bonds` | You hold people like rooted ground: steady nutrition, decades of shade. |
...
| `bonds` | You flow alongside people for years without ever quite pooling. The closeness is real. So is the channel. |
...
| `bonds` | You share deeply and account silently. Friends rarely know the ledger exists. |
...
| `bonds` | You feed your people in trickles: check-ins, small comforts, presence that arrives like rain. |
...
| `bonds` | You charm in ripples and test with depths. Minds that swim keep you. |
...
| `bonds` | Your network is an ocean: contacts on every shore, kept alive by circulation. |
...
| `bonds` | You sustain people in steady supply: care arriving on schedule like good rain. |
...
| `bonds` | You protect invisibly: threats redirected before your people knew they existed. |
...
| `bonds` | You keep relations in smooth passage: friction eased, protocol invisible. |
...
| `bonds` | You know people at depth: their undercurrents legible, your own kept dark. |
...
| `bonds` | You nourish invisibly: the steady one whose care is noticed only in drought. |
...
| `bonds` | You befriend like a campfire: openly, warmly, and on equal footing or not at all. |
...
| `bonds` | Your friendships run hot and competitive: shared adventures, traded dares, occasional burns. |
...
| `bonds` | You gather people around your glow and feed them till they shine back. |
...
| `bonds` | People orbit your light. Keep the few who stay when you are unlit. |
...
| `bonds` | Your network glows: everyone remembers you, and doors warm before you knock. |
...
| `bonds` | You tend relationships like a stove: daily fuel, steady heat, no cold mornings. |
...
| `bonds` | You bond in campaigns: comrade warmth, tested and total. |
...
| `bonds` | You lead relationships openly: visible loyalty, praise given in daylight. |
...
| `bonds` | You connect in intense sparks: rare kindred minds, instantly recognized. |
...
| `bonds` | You gather people: the hearth-keeper every found family forms around. |
