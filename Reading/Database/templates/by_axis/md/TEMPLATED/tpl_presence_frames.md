# tpl_presence_frames  ·  TEMPLATED archetype
...
|---|---|
| `pattern` | *(unauthored)* |
| `clauses.dominant` | *(unauthored)* |
| `clauses.present` | *(unauthored)* |
| `clauses.scarce` | *(unauthored)* |
| `clauses.absent` | *(unauthored)* |
