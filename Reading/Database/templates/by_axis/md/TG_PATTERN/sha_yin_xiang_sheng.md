# 杀印相生 — Pressure feeds the Sage  ·  TG_PATTERN archetype
...
| **axis** | TG_PATTERN |
| **key** | 杀印相生 |
| **canonical name** | Pressure feeds the Sage |
...
|---|---|
| `name_zh` | 杀印相生 |
| `name_en` | Pressure feeds the Sage |
| `trigger_gods[0].0` | 七杀 |
| `trigger_gods[1].0` | 偏印 |
| `trigger_gods[1].1` | 正印 |
| `target_domains` | Career · Growth · Mind |
