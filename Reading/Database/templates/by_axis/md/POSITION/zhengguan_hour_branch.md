# 正官在时支 — The Magistrate inside the Legacy Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 正官在时支 |
| **canonical name** | The Magistrate inside the Legacy Gate |
...
| Variable | Value |
|---|---|
| `term` | The Magistrate inside the Legacy Gate |
| `term_zh` | 正官在时支 |
| `gate` | Legacy Gate |
| `slot_zh` | 时支 |
| `slot_kind` | branch |
