# 正官在时支 — The Magistrate inside the Hour Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 正官在时支 |
| **canonical name** | The Magistrate inside the Hour Gate |
...
| Variable | Value |
|---|---|
| `term` | The Magistrate inside the Hour Gate |
| `term_zh` | 正官在时支 |
| `gate` | Hour Gate |
| `slot_zh` | 时支 |
| `slot_kind` | branch |
