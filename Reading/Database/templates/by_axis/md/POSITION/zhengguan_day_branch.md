# 正官在日支 — The Magistrate inside the Partner Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 正官在日支 |
| **canonical name** | The Magistrate inside the Partner Gate |
...
| Variable | Value |
|---|---|
| `term` | The Magistrate inside the Partner Gate |
| `term_zh` | 正官在日支 |
| `gate` | Partner Gate |
| `slot_zh` | 日支 |
| `slot_kind` | branch |
