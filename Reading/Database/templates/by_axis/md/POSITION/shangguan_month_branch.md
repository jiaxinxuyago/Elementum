# 伤官在月支 — The Virtuoso inside the Career Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 伤官在月支 |
| **canonical name** | The Virtuoso inside the Career Gate |
...
| Variable | Value |
|---|---|
| `term` | The Virtuoso inside the Career Gate |
| `term_zh` | 伤官在月支 |
| `gate` | Career Gate |
| `slot_zh` | 月支 |
| `slot_kind` | branch |
