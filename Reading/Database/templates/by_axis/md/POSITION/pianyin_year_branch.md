# 偏印在年支 — The Alchemist inside the Origin Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 偏印在年支 |
| **canonical name** | The Alchemist inside the Origin Gate |
...
| Variable | Value |
|---|---|
| `term` | The Alchemist inside the Origin Gate |
| `term_zh` | 偏印在年支 |
| `gate` | Origin Gate |
| `slot_zh` | 年支 |
| `slot_kind` | branch |
