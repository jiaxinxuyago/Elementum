# 偏印在日支 — The Alchemist inside the Partner Gate  ·  POSITION archetype
...
| **axis** | POSITION |
| **key** | 偏印在日支 |
| **canonical name** | The Alchemist inside the Partner Gate |
...
| Variable | Value |
|---|---|
| `term` | The Alchemist inside the Partner Gate |
| `term_zh` | 偏印在日支 |
| `gate` | Partner Gate |
| `slot_zh` | 日支 |
| `slot_kind` | branch |
