...
| `gifts[0].dim` | others build on you |
...
| `shadows[1].dim` | endures not acts |
...
| `shadows[2].dim` | holds ended things |
...
| `shadows[4].dim` | capacity straining |
