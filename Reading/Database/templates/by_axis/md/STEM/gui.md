...
| `shadows[0].bands` | all |
| `shadows[1].phrase` | Conflict-averse |
...
| `shadows[2].bands` | all |
| `shadows[3].phrase` | Unpersuadable |
...
| `shadows[4].phrase` | Self-doubting |
