...
| `dm_overview` | The Rain is Yin Water, the last sign in the old count, the water that closes the circle so it can begin again. It is rain, dew, and mist, the moisture that arrives everywhere and forces nothing. The old telling sets it at winter's end, falling softly on planted fields through the night. By morning it is gone, and everything it touched has quietly agreed to grow. |
