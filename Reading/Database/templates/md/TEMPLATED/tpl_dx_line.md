# tpl_dx_line  ·  TEMPLATED archetype
...
| Variable | Value |
|---|---|
| `pattern` | Your {El} is {Cond} — {Remedy} it. |
| `clauses.mapping` | role-driven (owner-ratified 2026-07-23): friction-side incl. core excess → Overfueled·Channel · catalyst-side incl. missing → Underfueled·Refill · Balanced chart → Balanced·keep the mix |
