# BLIND GENERATION TEST · STEM_BAND 癸 Underfueled
...
Stem 癸 The Rain, Yin Water. Spine: permeates. Band: open = Underfueled (the core burns more than it takes in). Manifesto: "Felt before spoken · You are the Water that quietly changes whatever it touches.". dm_overview (the sign whose central image sentence 1 must receive): "The Rain is Yin Water, the last sign in the count, the water that closes the circle so it can begin again. It is rain, dew, and mist, the moisture that arrives everywhere and forces nothing. At winter's end it falls softly on planted fields through the night. By morning it is gone, and everything it touched has quietly agreed to grow.". Baseline yourNature_desc (band-neutral, for the person's trait): "You feel what a day is carrying before anyone says so, and you take it in the way ground takes rain. Most of it grows something. Some of it was never yours to hold, and telling the difference is the quiet work of your life.".
