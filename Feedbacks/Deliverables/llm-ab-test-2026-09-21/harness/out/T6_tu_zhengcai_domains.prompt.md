# BLIND GENERATION TEST · ELEMENT_GOD 土_正财 k2_domain_readings
...
Cell 土_正财 (Earth carrying the Steward). Persona The Steward (正财). Definition line: "Methodical, directed acquisition, the value built and kept". Keyword Caution, charge gentle, poles catalyst Security / friction Hoarding. Family function: Action. Classical portrait: methodical, directed acquisition, value built and kept; caution, thrift, the slow ledger. Ruled domains: Wealth, Savings, Steady love. Sibling (other polarity of the family): 偏财.
Element arena: Earth (ground, soil, load, field, bedrock, harvest). dm_element: Wood. structural_interaction: "Wood directing Earth cross-polarity — reach shaping stability into structured cultivation".
...
- adj_chips: {"catalyst":["Thrifty","Steady","Well-stocked"],"friction":["Hoarding","Immobile","Cheap"]}

## TASK

Write k2_domain_readings for 土_正财 as {"Wealth": "...", "Savings": "...", "Steady love": "..."}, one paragraph of 18–55 words per domain. Return the JSON only.