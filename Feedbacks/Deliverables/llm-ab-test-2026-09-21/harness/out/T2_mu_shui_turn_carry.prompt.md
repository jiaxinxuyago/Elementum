# BLIND GENERATION TEST · ELEMENT_PAIR 木_水 friction turn + carry poles
...
Core element Wood, energy element Water. Law: Water feeds Wood (水生木: rain raises the forest). Relative to the core the energy is the feeder, so Water is this core's Mind.
...
- mechanism.catalyst_turn (the other pole, for contrast and the repetition law): "Run thin, the canopy outpaces the rain: ambition still reaching while the soil dries. Your chart asks you to feed the water table. Rest, read, go quiet and refill."
...
- carry.catalyst (the other pole, for the cut law): {"clause":"The canopy outpaces the rain: ambition still reaching while the soil dries.","remedy":"Rest, read, go quiet and refill."}
- carry.wide: {"clause":"Water is already here in plenty, the rain the whole tree drinks from.","remedy":"Stop refilling. Grow something from what you already know."}
- carry.missing: {"clause":"No water at the root: reaching on dry ground, nothing taken in before it is spent.","remedy":"Borrow water: rest, reading, one quiet hour."}
- carry.spared: {"clause":"Water runs absent, and the ground stays firm: nothing floods, nothing waits on one more season.","remedy":"Keep it dry. Act on what you know."}
