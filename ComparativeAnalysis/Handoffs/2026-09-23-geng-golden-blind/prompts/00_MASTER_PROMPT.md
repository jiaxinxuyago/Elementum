# 00 · THE MASTER PROMPT

_Prompt file (data). The one block every generation prompt opens with, identical for every field. Edit here; the harness pastes this file verbatim. Born 2026-09-21 from REA_17 v0.3 §1, itself compiled from REA_16 §1, §1b, §2b, §2b-G, §3, §4, REA_02 §1, §2, §8, REA_04 PART 8. On any disagreement the source document wins._
...
| Date | Change | Ruling |
|---|---|---|
| 2026-09-21 | Born from REA_17 v0.3 §1 | compilation, no new rule |
| 2026-09-21 | The hedge ban narrowed to reflex forms | owner ruling Q0, 2026-09-21 (REA_16 §6) |
| 2026-09-23 | The freedom clause: what is fixed, what is the writer's; craft notes are guidance, not gate | owner 2026-09-23 (the handoff readiness check) |
