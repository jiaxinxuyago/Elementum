# BLIND GENERATION TEST · POSITION.health_line · zhengcai_hour_stem
...
Named event: "The Steward at the Hour Gate" · 正财在时干. Persona The Steward (正财). Definition line: "Methodical, directed acquisition, the value built and kept". Keyword Caution, charge gentle, poles catalyst Security / friction Hoarding. Family function: Action. Cost dimension: value built and kept; counting what others spend freely. Arena: granary, kept things, stone by stone, seasons of saving. Classical portrait: methodical, directed acquisition; value built and kept; caution, thrift, the slow ledger. Ruled domains: Wealth, Savings, Steady love. Sibling (other polarity of the family): 偏财.
Gate: Hour Gate (ground: children, output, late life). Slot kind: stem (stem = the shown face, "at the Gate"). Era: the Late Chapter (48+). Relations register: children, students, heirs. Seat rank: fifth of seven (时干). Declared domains: ["Wealth","Family"].
...
Write health_line for zhengcai_hour_stem as {"health_line": "..."}: ≤30 words, wellness register, non-medical: the seat's body correspondence in gentle tendency language; never a symptom assigned as fact, never a diagnosis.
