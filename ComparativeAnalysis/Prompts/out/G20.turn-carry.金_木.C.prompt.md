...
- mechanism.catalyst_turn: [REDACTED: the target field]
...
- carry.catalyst: [REDACTED: the target field]
...
- carry.wide: [REDACTED: the target field]
- carry.missing: [REDACTED: the target field]
...
Chart under test: golden 庚 The Blade, 1995-04-29 18:00 Beijing (Overfueled; Earth 33 / Wood 33 / Metal 23 / Water 6 / Fire 5). Band Overfueled. Wood runs 33%: catalyst, abundant; the state under test is catalyst.

## TASK

Write for 金_木: (a) mechanism.catalyst_turn (≤35 words, opens "Run thin,"); (b) carry.catalyst = {clause ≤18w, remedy ≤12w} CUT from that turn (its first clause and its own directive); (c) carry.missing = {clause, remedy} for Wood wanted and absent (borrow it); (d) carry.wide = {clause, remedy} for Wood wanted and abundant or dominant, the plentiful line opening with one of the eight wide openers and no door metaphor. Return {"catalyst_turn": "...", "carry": {"catalyst": {...}, "missing": {...}, "wide": {...}}} only.
