# BLIND GENERATION TEST · ELEMENT_PAIR.function.definition · 金_火 · catalyst
...
Chart under test: golden 庚 The Blade, 1995-04-29 18:00 Beijing (Overfueled; Earth 33 / Wood 33 / Metal 23 / Water 6 / Fire 5). Band Overfueled. Fire runs 5%: catalyst, thin; the state under test is catalyst.

## TASK

Write function.definition_catalyst for 金_火 as {"definition_catalyst": "..."}: ≤55 words, second person, opening with the formula "Fire is your Order, and as a catalyst, it is …", then a concrete-life inventory of what the function does when it runs right.
