# BLIND GENERATION TEST · ELEMENT_PAIR.function.advise · 金_火 · catalyst
...
**`ELEMENT_PAIR.function.advise_catalyst`** · **`ELEMENT_PAIR.function.advise_catalyst` / `advise_friction`** · energy page, the reading's last paragraph · reading (B1–B2) · second person, imperatives allowed · ≤60 words each · LOCKED ×25
...
Cell 金_火. Core element Metal, energy element Fire. Law: Fire tames Metal (火克金: the forge softens the blade). Relative to the core the energy is the tamer, so Fire is this core's Order.
- mechanism.classic (the sourced epigraph): "精勝堅，故火勝金"
...
- function.advise_catalyst: [REDACTED: the target field]
...
- carry.catalyst: {"clause":"Nothing tempers you: an edge that keeps its first shape and calls it character.","remedy":"Take the demanding role, the audit, the arena."}
- carry.friction: {"clause":"The forge never closes: constant heat, no bench time, a blade softening under pressure it never leaves.","remedy":"Step out of the fire long enough to hold an edge."}
...
- carry.missing: {"clause":"Nothing tempers the edge: a shape that was never tested, an edge that never met an arena.","remedy":"Borrow heat: one demanding role, one audit."}
- carry.spared: {"clause":"Fire runs absent, and the metal keeps its temper: no forge to soften it, no heat to answer.","remedy":"Keep it cool. Choose your pressures."}
- carry.thin: {"clause":"Fire runs thin and unwanted: a low flame, easy to stand beside.","remedy":"Let it stay low."}
...
- carry_yin.friction: {"clause":"The wheel never stops: constant pressure, no bench time, a stone thinned by a polish it never leaves.","remedy":"Step off the wheel long enough to keep a facet."}
- carry_yin.wide: {"clause":"Fire is easy for you to reach, the fire that finishes the stone.","remedy":"Take the pressure you have. Let it sharpen you."}

The classical excess idiom for this cell (say it in English in carry.excess, never quote it): 金衰遇火，必见销熔 (衰而逢克, the Order door).
...
Chart under test: contrast 辛 The Jewel, Overfueled, heavy Earth (fixture: Metal 20 / Earth 45 / Wood 15 / Fire 10 / Water 10). Band Overfueled. Fire runs 10%: catalyst, thin; the state under test is catalyst.

## TASK

Write function.advise_catalyst for 金_火 as {"advise_catalyst": "..."}: ≤60 words, second person, imperatives allowed: one sentence naming the psychological truth under the catalyst state, then three or four small actions with objects and cadences, ending on the smallest one. Plain, specific, no metaphor stacking, no prescription of investments, careers or medical acts, never a guarantee.

Output shape: {"advise_catalyst": "..."}
