# BLIND GENERATION TEST · ELEMENT_PAIR.function.definition · 金_土 · friction
...
- Exemplar (金_土 friction): "[withheld: this exemplar is the cell under test]"
...
- function.definition_friction: [REDACTED: the target field]
...
Write function.definition_friction for 金_土 as {"definition_friction": "..."}: ≤55 words, second person, opening with the formula "Earth is your Mind, and as a friction, it is …", then a concrete-life inventory of what the function does when it overgrows.

Output shape: {"definition_friction": "..."}
