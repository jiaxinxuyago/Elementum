# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.base · 金_金 · friction
...
Write mechanism.base for 金_金 as {"base": "..."}: 45–75 words, fully third person, the two-energy chemistry only (what 生 or 克 means physically between these two materials), no "you", no function claim, no persona.
