# BLIND GENERATION TEST · STEM.inscription · geng
...
- inscription: [REDACTED: the target field]
...
Write the inscription for 庚 The Blade as {"inscription": "..."}: two beats, mechanism then cost, "you" within the first three words, ≤17 words and ≤85 characters.

Output shape: {"inscription": "..."}
