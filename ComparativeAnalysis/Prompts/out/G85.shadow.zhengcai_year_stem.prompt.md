# BLIND GENERATION TEST · POSITION.shadow_line · zhengcai_year_stem
...
Write shadow_line for zhengcai_year_stem as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
