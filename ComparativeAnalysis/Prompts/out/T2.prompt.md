# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.turn+carry · 木_水 · friction
...
Cell 木_水. Core element Wood, energy element Water. Law: Water feeds Wood (水生木: rain raises the forest). Relative to the core the energy is the feeder, so Water is this core's Mind.
- mechanism.classic (the sourced epigraph): "因水潤而能生"
...
- carry.catalyst: {"clause":"The canopy outpaces the rain: ambition still reaching while the soil dries.","remedy":"Rest, read, go quiet and refill."}
...
The classical excess idiom for this cell (say it in English in carry.excess, never quote it): 木赖水生，水多木漂 (生之太过, the Mind door).
