# BLIND GENERATION TEST · TG_PATTERN.line · xiao_shen_duo_shi
...
- Construct: the compact chemistry note: the two personas share the chart and what their contest does, then the cure in one clause. Exemplar (枭神夺食): "[withheld: this exemplar is the cell under test]"
...
- line: [REDACTED: the target field]
...
Write line for xiao_shen_duo_shi as {"line": "..."}: ≤40 words, second person, the two personas share the chart and what their contest does, then the cure in one clause.
