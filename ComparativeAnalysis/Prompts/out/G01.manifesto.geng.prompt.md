# BLIND GENERATION TEST · STEM.manifesto · geng
...
- manifesto: [REDACTED: the target field]
...
Write the manifesto couplet for 庚 The Blade as {"manifesto": "L1 · L2"}: L1 a noun-led hierarchy claim of 2 to 4 words, L2 "You are the Metal that …" carrying the spine verb, ≤14 words in all, joined by " · ".

Output shape: {"manifesto": "..."}
