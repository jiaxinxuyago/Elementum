# BLIND GENERATION TEST · ELEMENT_GOD.fn_reading.row · 火_七杀 · catalyst · row 1
...
- fn_reading.catalyst.ledger (three rows, index-aligned to adj_chips.catalyst; authored order is significance order):
  ...
  - row 1 "Daring": [REDACTED: the target row]
...
- Sibling cell 火_正官 catalyst row 1 trait door, for contrast: "Your integrity gives off actual light. People behave better in your radius without being asked, the meeting sits straighter when you join, and the shady proposal dies unspoken because you happened to be at the table. You illuminate by standing there. It is a strange, real power."
...
Write the three door passages for the catalyst ledger row 1 of 火_七杀, word "Daring": {"word": "Daring", "doors": {"trait": "...", "scene": "...", "outside": "..."}}, each door 35–55 words. Trait opens on the trait claim; scene opens inside a representative situation with objects and a clock time; outside opens from how others see it and what it costs or pays.

Output shape: {"word": "Daring", "doors": {"trait": "...", "scene": "...", "outside": "..."}}
