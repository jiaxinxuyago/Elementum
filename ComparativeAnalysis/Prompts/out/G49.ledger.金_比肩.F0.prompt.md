# BLIND GENERATION TEST · ELEMENT_GOD.fn_reading.row · 金_比肩 · friction · row 0
...
Write the three door passages for the friction ledger row 0 of 金_比肩, word "Sealed-off": {"word": "Sealed-off", "doors": {"trait": "...", "scene": "...", "outside": "..."}}, each door 35–55 words. Trait opens on the trait claim; scene opens inside a representative situation with objects and a clock time; outside opens from how others see it and what it costs or pays.

Output shape: {"word": "Sealed-off", "doors": {"trait": "...", "scene": "...", "outside": "..."}}
