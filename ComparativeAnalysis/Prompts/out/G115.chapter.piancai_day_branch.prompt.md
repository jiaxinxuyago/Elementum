# BLIND GENERATION TEST · POSITION.life_chapter · piancai_day_branch
...
- life_chapter: [REDACTED: the target field]
...
Write life_chapter for piancai_day_branch as {"life_chapter": "..."}: 35–60 words, second person, the gate's era read with the persona's colour, labelled with the chapter name, an era as a tendency, never a dated event.

Output shape: {"life_chapter": "..."}
