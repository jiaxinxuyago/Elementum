# BLIND GENERATION TEST · POSITION.shadow_line · shishen_year_branch
...
Write shadow_line for shishen_year_branch as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
