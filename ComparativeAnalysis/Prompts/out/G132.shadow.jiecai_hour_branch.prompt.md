# BLIND GENERATION TEST · POSITION.shadow_line · jiecai_hour_branch
...
Write shadow_line for jiecai_hour_branch as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
