# BLIND GENERATION TEST · POSITION.health_line · bijian_month_stem
...
Named event: "The Twin at the Month Gate" · 比肩在月干. Persona The Twin (比肩). Definition line: "Same nature, same register, the standard you hold yourself to". Keyword Independence, charge steady, poles catalyst Self-trust / friction Isolation. Family function: Body. Cost dimension: the standard held to oneself; company that truly matches is rare. Arena: mirrors, stride, equal measure, walking beside. Classical portrait: same nature, same register; the standard held to oneself; self-reliance that can wall others out. Ruled domains: Peers, Independence, Self-reliance. Sibling (other polarity of the family): 劫财.
Gate: Month Gate (ground: work, parents, the chart's frame). Slot kind: stem (stem = the shown face, "at the Gate"). Era: the Rising Chapter (~16–35). Relations register: parents, siblings, colleagues. Seat rank: second of seven (月干). Declared domains: ["Career","Social"].
...
- domain_readings: {"Career":"Your working life is a solo instrument played in public: you rise on competence witnessed, own tasks whole, and stall wherever credit blurs. Choose roles with clean scoreboards. Promotion for you follows visibility of workmanship, so work where the work can be seen, and signed.","Social":"Your circle runs level: peers, never patrons, and friendship as a pact between equals. People trust you fast and lean on you rarely, because you signal so little need. Let two or three actually in. The Twin’s crowd is small on purpose, and it holds when chosen well."}
...
Write health_line for bijian_month_stem as {"health_line": "..."}: ≤30 words, wellness register, non-medical: the seat's body correspondence in gentle tendency language; never a symptom assigned as fact, never a diagnosis.
