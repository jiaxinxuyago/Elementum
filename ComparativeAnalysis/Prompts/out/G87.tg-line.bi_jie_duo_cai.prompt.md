# BLIND GENERATION TEST · TG_PATTERN.line · bi_jie_duo_cai
...
Write line for bi_jie_duo_cai as {"line": "..."}: ≤40 words, second person, the two personas share the chart and what their contest does, then the cure in one clause.
