# BLIND GENERATION TEST · ELEMENT_GOD.adj_chips · 金_比肩
...
Write adj_chips for 金_比肩 as {"catalyst": ["…","…","…"], "friction": ["…","…","…"]}: three chips per pole, 1–3 words each, significance order, three distinct dimensions per pole, high-school vocabulary, unique against the sibling cell's chips, no report-card register.
