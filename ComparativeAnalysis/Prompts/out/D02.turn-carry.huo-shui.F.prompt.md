# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.turn+carry · 火_水 · friction
...
- function.advise_friction: "Prudence past its dose becomes fear with a clipboard. Give small decisions a five-minute timer. Reserve real review for the truly irreversible. Once a month, act on a warm impulse the same day it arrives and audit the result later."
...
Write for 火_水: (a) mechanism.friction_turn (≤35 words, opens "Run heavy,"); (b) carry.friction = {clause ≤18w, remedy ≤12w} CUT from that turn (its first clause and its own directive); (c) carry.thin = {clause, remedy} for Water unwanted at ≤10%; (d) carry.excess = {clause, remedy} for dominant Water, the cell's idiom in English, never quoted. Return {"friction_turn": "...", "carry": {"friction": {...}, "thin": {...}, "excess": {...}}} only.
