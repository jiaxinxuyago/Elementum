# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.turn+carry · 金_水 · catalyst
...
Write for 金_水: (a) mechanism.catalyst_turn (≤35 words, opens "Run thin,"); (b) carry.catalyst = {clause ≤18w, remedy ≤12w} CUT from that turn (its first clause and its own directive); (c) carry.missing = {clause, remedy} for Water wanted and absent (borrow it); (d) carry.wide = {clause, remedy} for Water wanted and abundant or dominant, the plentiful line opening with one of the eight wide openers and no door metaphor. Return {"catalyst_turn": "...", "carry": {"catalyst": {...}, "missing": {...}, "wide": {...}}} only.
