# BLIND GENERATION TEST · ELEMENT_GOD.fn_reading.row · 土_偏印 · friction · row 1
...
- fn_reading.friction.ledger (three rows, index-aligned to adj_chips.friction; authored order is significance order):
  ...
  - row 1 "Brooding": [REDACTED: the target row]
...
Write the three door passages for the friction ledger row 1 of 土_偏印, word "Brooding": {"word": "Brooding", "doors": {"trait": "...", "scene": "...", "outside": "..."}}, each door 35–55 words. Trait opens on the trait claim; scene opens inside a representative situation with objects and a clock time; outside opens from how others see it and what it costs or pays.

Output shape: {"word": "Brooding", "doors": {"trait": "...", "scene": "...", "outside": "..."}}
