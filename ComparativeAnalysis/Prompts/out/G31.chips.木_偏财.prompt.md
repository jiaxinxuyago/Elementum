# BLIND GENERATION TEST · ELEMENT_GOD.adj_chips · 木_偏财
...
Write adj_chips for 木_偏财 as {"catalyst": ["…","…","…"], "friction": ["…","…","…"]}: three chips per pole, 1–3 words each, significance order, three distinct dimensions per pole, high-school vocabulary, unique against the sibling cell's chips, no report-card register.
