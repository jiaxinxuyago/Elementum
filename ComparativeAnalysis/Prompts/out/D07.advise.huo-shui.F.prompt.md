# BLIND GENERATION TEST · ELEMENT_PAIR.function.advise · 火_水 · friction
...
Cell 火_水. Core element Fire, energy element Water. Law: Water tames Fire (水克火: rain ends the blaze). Relative to the core the energy is the tamer, so Water is this core's Order.
- mechanism.classic (the sourced epigraph): "眾勝寡，故水勝火"
...
- function.advise_catalyst: "Discipline, for you, is imported, so import it well. Sleep on anything irreversible. Keep a reviewer you cannot charm and show them everything big. Put a cool number on every hot plan before saying yes."
- function.advise_friction: [REDACTED: the target field]
...
- carry.catalyst: {"clause":"Nothing checks the burn: enthusiasm with no depth gauge, light that has never been rained on.","remedy":"Seek the cold reviewer, the quiet counsel."}
- carry.friction: {"clause":"The rain never lifts: constant drizzle on every spark, caution soaking the kindling before it catches.","remedy":"A doused fire serves no one."}
...
- carry.missing: {"clause":"Nothing checks the burn: enthusiasm without a gauge, light that has never been rained on.","remedy":"Borrow water: one cold reviewer."}
- carry.spared: {"clause":"Water runs absent, and nothing douses the flame: no drizzle on the spark, no second-guessing.","remedy":"Keep it. Choose one check you trust."}
- carry.thin: {"clause":"Water runs thin and unwanted: a light rain, easy to shine through.","remedy":"Shine through it."}
...
The classical excess idiom for this cell (say it in English in carry.excess, never quote it): 火弱逢水，必为熄灭 (衰而逢克, the Order door).
...
Write function.advise_friction for 火_水 as {"advise_friction": "..."}: ≤60 words, second person, imperatives allowed: one sentence naming the psychological truth under the friction state, then three or four small actions with objects and cadences, ending on the smallest one. Plain, specific, no metaphor stacking, no prescription of investments, careers or medical acts, never a guarantee.

Output shape: {"advise_friction": "..."}
