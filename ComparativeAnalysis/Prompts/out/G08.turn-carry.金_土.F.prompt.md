...
- Exemplar (金_土 friction): "[withheld: this exemplar is the cell under test]" · (水_火 friction, 2026-09-20): "Run heavy, the water starts to boil: every bright chance chased, every quick pivot taken, each one costing more recovery than it returns. Let the next hot offer wait a week."
...
- Exemplar (金_土): wide "You are well supplied with Earth, the ground the ore grows in." / "Use what the ground gave you. Cut something." · excess "[withheld: this exemplar is the cell under test]" / "[withheld: this exemplar is the cell under test]" · missing "No ground under the edge: judgment made on the spot, nothing settled in first." / "Borrow ground: a mentor, a book, one slow evening."
...
- mechanism.friction_turn: [REDACTED: the target field]
...
- carry.friction: [REDACTED: the target field]
...
- carry.thin: [REDACTED: the target field]
- carry.excess: [REDACTED: the target field]
...
Write for 金_土: (a) mechanism.friction_turn (≤35 words, opens "Run heavy,"); (b) carry.friction = {clause ≤18w, remedy ≤12w} CUT from that turn (its first clause and its own directive); (c) carry.thin = {clause, remedy} for Earth unwanted at ≤10%; (d) carry.excess = {clause, remedy} for dominant Earth, the cell's idiom in English, never quoted. Return {"friction_turn": "...", "carry": {"friction": {...}, "thin": {...}, "excess": {...}}} only.
