# BLIND GENERATION TEST · ELEMENT_GOD.k2_overview · 木_正财
...
Write k2_overview for 木_正财 as {"k2_overview": "..."}: 40–70 words, second person, opening "Your Wood", the persona's current in the element's material, the persona name once with its definition sense, ending on the rent it asks. It must not fit the sibling persona.
