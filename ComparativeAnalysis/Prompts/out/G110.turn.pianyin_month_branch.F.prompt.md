# BLIND GENERATION TEST · POSITION.turn · pianyin_month_branch · friction
...
**`POSITION.turn_catalyst`** · **`POSITION.turn_catalyst` / `turn_friction`** · the seat panel, band-resolved like the mechanism turns · therapist-psychic · second person · ≤30 words each · LOCKED ×70
- Construct: "Run thin, the seat asks for …" / "Run heavy, … here" with one directive. Exemplar: "[withheld: this exemplar is the cell under test]"
...
- turn_friction: [REDACTED: the target field]
...
Write turn_friction for pianyin_month_branch as {"turn_friction": "..."}: ≤30 words, opens "Run heavy," with one directive.

Output shape: {"turn_friction": "..."}
