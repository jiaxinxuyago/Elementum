# BLIND GENERATION TEST · POSITION.turn · zhengcai_year_stem · catalyst
...
Write turn_catalyst for zhengcai_year_stem as {"turn_catalyst": "..."}: ≤30 words, opens "Run thin, the seat asks for" with one directive.
