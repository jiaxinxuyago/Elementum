# BLIND GENERATION TEST · ELEMENT_PAIR.function.definition · 金_木 · catalyst
...
Write function.definition_catalyst for 金_木 as {"definition_catalyst": "..."}: ≤55 words, second person, opening with the formula "Wood is your Action, and as a catalyst, it is …", then a concrete-life inventory of what the function does when it runs right.
