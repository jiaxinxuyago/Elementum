# BLIND GENERATION TEST · STEM.dm_overview · ding
...
- dm_overview (the sign): [REDACTED: the target field]
...
Write dm_overview for 丁 The Candle as {"dm_overview": "..."}: 55–85 words, third person, opening on the archetype name ("The Candle is …"), the sign the only actor, no "you".

Output shape: {"dm_overview": "..."}
