# BLIND GENERATION TEST · STEM.yourNature_desc · geng
...
- yourNature_desc (baseline, band-neutral): [REDACTED: the target field]
...
Write the baseline yourNature_desc for 庚 The Blade as {"yourNature_desc": "..."}: 30–55 words, opens on "You", the person decoded from the sign, cost as plain fact.

Output shape: {"yourNature_desc": "..."}
