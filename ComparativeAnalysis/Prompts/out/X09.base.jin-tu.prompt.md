# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.base · 金_土 · friction
...
- Exemplar (金_土): "[withheld: this exemplar is the cell under test]"
...
- mechanism.base: [REDACTED: the target field]
...
- carry_yin.friction: {"clause":"The setting closes over the stone: so much preparation that the jewel never leaves the box.","remedy":"Take it out and wear it somewhere real."}
...
Write mechanism.base for 金_土 as {"base": "..."}: 45–75 words, fully third person, the two-energy chemistry only (what 生 or 克 means physically between these two materials), no "you", no function claim, no persona.
