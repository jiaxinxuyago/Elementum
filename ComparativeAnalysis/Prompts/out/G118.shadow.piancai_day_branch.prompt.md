# BLIND GENERATION TEST · POSITION.shadow_line · piancai_day_branch
...
Write shadow_line for piancai_day_branch as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
