# BLIND GENERATION TEST · ELEMENT_GOD.adj_chips · 水_食神
...
- adj_chips: [REDACTED: the target field]
...
Write adj_chips for 水_食神 as {"catalyst": ["…","…","…"], "friction": ["…","…","…"]}: three chips per pole, 1–3 words each, significance order, three distinct dimensions per pole, high-school vocabulary, unique against the sibling cell's chips, no report-card register.

Output shape: {"catalyst": [3 strings], "friction": [3 strings]}
