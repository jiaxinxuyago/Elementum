# BLIND GENERATION TEST · POSITION.turn · piancai_day_branch · catalyst
...
- turn_catalyst: [REDACTED: the target field]
...
Write turn_catalyst for piancai_day_branch as {"turn_catalyst": "..."}: ≤30 words, opens "Run thin, the seat asks for" with one directive.

Output shape: {"turn_catalyst": "..."}
