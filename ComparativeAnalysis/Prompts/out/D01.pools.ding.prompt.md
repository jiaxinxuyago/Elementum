# BLIND GENERATION TEST · STEM.gifts+shadows · ding
...
Stem 丁 The Candle, Yin Fire. Spine: concentrates. Arena: Fire (flame, light, warmth, fuel, the hearth, the blaze).
Angle Map row: | 丁 The Candle | Narrowness: one thing lit completely, everything else dark | night, close distance, small light, one circle, the dark just outside | intimate close-range lines, small words, held steady |
Angle not to borrow: not the unwitnessed-martyr angle, which belongs to 丙, 己 and 庚 each differently; write from this stem's own row.
...
- dm_overview (the sign): "The Candle is Yin Fire, the fire that agreed to be small. It keeps the hours after dark, when the great light has gone home and warmth becomes a personal matter. Lamp light, hearth light, the flame a hand can shelter. In a night window it holds one table, one page, one face, while the dark politely keeps its distance."
- yourNature_desc (baseline, band-neutral): "You give whatever you turn toward all of you, and people who've felt that never quite forget it. It's the closest thing to being truly seen most of them get. One flame, one circle, and a lot of patient darkness just outside it."
- door_note (function → element): {"body":"Fire","mind":"Wood","expression":"Earth","action":"Metal","order":"Water"}. The yin stem reads carry_yin.excess where the cell carries it.

### Pair cell 火_火 (door body, Core element Fire, energy element Fire. Law: Fire and Fire are the same element (the self pair). Relative to the core the energy is the self, so Fire is this core's Body.)
- function.definition_catalyst: "Fire is your Body, and running thin, it is the energy behind your warmth: sociability, drive, the lift that makes mornings possible. Yours runs in bursts, so depletion shows as dimness with people you love."
- function.definition_friction: "Fire is your Body, and running over, it is more heat than your days can spend: sleep that will not come, intensity leaking into every conversation, rest that feels like a punishment."
- carry.wide: none (self pair): the Body wide gift is cut from this cell's definition_catalyst, echo_of = 火_火.function.definition_catalyst
- carry.excess: {"clause":"Strong fire wants earth: so much light nothing else is visible.","remedy":"Settle some flame. Build something."}

### Pair cell 火_木 (door mind, Core element Fire, energy element Wood. Law: Wood feeds Fire (木生火: dry branches make the flame). Relative to the core the energy is the feeder, so Wood is this core's Mind.)
...
- carry.wide: {"clause":"You were given plenty of Wood, the fuel your light was waiting for.","remedy":"Burn what you have gathered. Light one thing this week."}
- carry.excess: {"clause":"Too much wood feeds the fire past its task: a blaze that eats a season's fuel overnight.","remedy":"Bank the fire. Save half the wood."}

### Pair cell 火_土 (door expression, Core element Fire, energy element Earth. Law: Fire feeds Earth (火生土: ash becomes soil). Relative to the core the energy is the fed, so Earth is this core's Expression.)
...
- carry.wide: {"clause":"Earth is already here in plenty, the hearth that keeps what you burn.","remedy":"Build one thing that will outlast the evening."}
- carry.excess: {"clause":"Too much earth dims the fire: every spark pressed into form, output hardening while the light thins.","remedy":"Let some fires just burn."}

### Pair cell 火_金 (door action, Core element Fire, energy element Metal. Law: Fire tames Metal (火克金: the forge softens the blade). Relative to the core the energy is the tamed, so Metal is this core's Action.)
...
- carry.wide: {"clause":"You are well supplied with Metal, the hard thing your heat was made to work.","remedy":"Work the hard, valuable thing in front of you."}
- carry.excess: {"clause":"Too much metal puts out the fire: more hard work than the heat can take, effort cooling.","remedy":"Work less metal. Add wood."}

### Pair cell 火_水 (door order, Core element Fire, energy element Water. Law: Water tames Fire (水克火: rain ends the blaze). Relative to the core the energy is the tamer, so Water is this core's Order.)
- function.definition_catalyst: "Water is your Order, and as a catalyst, it is the cool check your intensity needs: reviews, budgets, one person whose calm questions slow you down before the leap. Your best decisions have all survived a night of doubt."
- function.definition_friction: "Water is your Order, and as a friction, it is caution soaking through everything: every plan reviewed until the moment passes, every spark second-guessed into a maybe. The checking now costs more than the mistakes would, and the hardest judge of the flame is you."
- carry.wide: {"clause":"There is no shortage of Water in you, the depth that keeps the burn honest.","remedy":"Take the cold review. Let it steady you."}
- carry.excess: {"clause":"Weak fire drowns in strong water: checks past what the flame can survive, caution putting the light out.","remedy":"Get out of the rain. Add wood."}

Chart under test: contrast 丁 The Candle, weak, one Order door (fixture: Wood 30 / Fire 15 / Earth 5 / Metal 10 / Water 40). Band Underfueled.

## TASK

Write the full gifts and shadows pool for 丁 The Candle: exactly 7 gifts and 7 shadows, as {"gifts":[...],"shadows":[...]} where every item is {"phrase","dim","door","face","echo_of","desc"}. Faces: one "echo" item per door on each side (gift cut from definition_catalyst, shadow from definition_friction); Body and Mind carry a second item (gift "wide" cut from carry.wide, shadow "excess" cut from carry.excess or carry_yin.excess where the cell carries it). echo_of is the exact station path, e.g. "火_木.function.definition_catalyst".
