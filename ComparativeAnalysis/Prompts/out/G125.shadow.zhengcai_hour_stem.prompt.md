# BLIND GENERATION TEST · POSITION.shadow_line · zhengcai_hour_stem
...
Write shadow_line for zhengcai_hour_stem as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
