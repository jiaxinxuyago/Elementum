# BLIND GENERATION TEST · TG_PATTERN.reading · bi_jie_duo_cai
...
Pattern 比劫夺财, "The peers contest the purse". Sides: The Twin (比肩) or The Rival (劫财) × The Steward (正财) or The Horizon (偏财). Target domains: ["Wealth"]. The fused tier applies when both sides share one pillar.
...
Write reading for bi_jie_duo_cai as {"reading": "..."}: 45–70 words, pure you-language analysis of the pattern's effect, no classics, no persona mechanics, structural cure; it opens "One catch runs underneath" and reads as a continuation of a domain paragraph.
