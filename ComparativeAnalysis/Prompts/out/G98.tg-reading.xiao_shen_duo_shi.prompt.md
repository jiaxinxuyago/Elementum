# BLIND GENERATION TEST · TG_PATTERN.reading · xiao_shen_duo_shi
...
- Construct: pure you-language analysis of the pattern's effect, no classics, no persona mechanics, structural cure, one health note where the classics carry one. Exemplar: "[withheld: this exemplar is the cell under test]"
...
Pattern 枭神夺食, "The Alchemist starves the Artisan". Sides: The Alchemist (偏印) × The Artisan (食神). Target domains: ["Mind","Career","Health"]. The fused tier applies when both sides share one pillar.
...
Write reading for xiao_shen_duo_shi as {"reading": "..."}: 45–70 words, pure you-language analysis of the pattern's effect, no classics, no persona mechanics, structural cure; it opens "One catch runs underneath" and reads as a continuation of a domain paragraph.
