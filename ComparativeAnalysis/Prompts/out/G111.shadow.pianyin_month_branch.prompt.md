# BLIND GENERATION TEST · POSITION.shadow_line · pianyin_month_branch
...
- shadow_line: [REDACTED: the target field]
...
Write shadow_line for pianyin_month_branch as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.

Output shape: {"shadow_line": "..."}
