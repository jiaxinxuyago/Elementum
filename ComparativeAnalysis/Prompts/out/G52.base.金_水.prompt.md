# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.base · 金_水 · catalyst
...
Write mechanism.base for 金_水 as {"base": "..."}: 45–75 words, fully third person, the two-energy chemistry only (what 生 or 克 means physically between these two materials), no "you", no function claim, no persona.
