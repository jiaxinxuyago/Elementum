# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.turn+carry · 金_金 · friction
...
Write for 金_金: (a) mechanism.friction_turn (≤35 words, opens "Run heavy,"); (b) carry.friction = {clause ≤18w, remedy ≤12w} CUT from that turn (its first clause and its own directive); (c) carry.thin = {clause, remedy} for Metal unwanted at ≤10%; (d) carry.excess = {clause, remedy} for dominant Metal, the cell's idiom in English, never quoted. Return {"friction_turn": "...", "carry": {"friction": {...}, "thin": {...}, "excess": {...}}} only.
