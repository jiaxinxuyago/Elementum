# BLIND GENERATION TEST · TG_PATTERN.fused_line · bi_jie_duo_cai
...
- fused_line: [REDACTED: the target field]
...
Write fused_line for bi_jie_duo_cai as {"fused_line": "..."}: ≤25 words, appended when both sides share one pillar.

Output shape: {"fused_line": "..."}
