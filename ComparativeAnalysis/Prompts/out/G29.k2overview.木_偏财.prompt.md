# BLIND GENERATION TEST · ELEMENT_GOD.k2_overview · 木_偏财
...
- Sibling cell 木_正财 k2_overview, for contrast: "Your Wood moves as the Steward: growth banked in rings. You build worth the way orchards do, planted early, tended patiently, harvested honestly, replanted always. Assets in your care grow. So do people. Your fortune is cumulative and alive, and it rewards the seasons you refuse to rush."
...
Write k2_overview for 木_偏财 as {"k2_overview": "..."}: 40–70 words, second person, opening "Your Wood", the persona's current in the element's material, the persona name once with its definition sense, ending on the rent it asks. It must not fit the sibling persona.
