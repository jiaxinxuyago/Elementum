# BLIND GENERATION TEST · ELEMENT_GOD.k2_overview · 金_劫财
...
Write k2_overview for 金_劫财 as {"k2_overview": "..."}: 40–70 words, second person, opening "Your Metal", the persona's current in the element's material, the persona name once with its definition sense, ending on the rent it asks. It must not fit the sibling persona.
