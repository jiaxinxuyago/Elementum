# BLIND GENERATION TEST · POSITION.shadow_line · bijian_month_stem
...
Write shadow_line for bijian_month_stem as {"shadow_line": "..."}: ≤30 words, the persona's dark face in that gate, one line.
