# BLIND GENERATION TEST · ELEMENT_PAIR.mechanism.turn+carry · 金_木 · catalyst
...
Cell 金_木. Core element Metal, energy element Wood. Law: Metal tames Wood (金克木: the knife prunes the branch). Relative to the core the energy is the tamed, so Wood is this core's Action.
- mechanism.classic (the sourced epigraph): "剛勝柔，故金勝木"
...
- mechanism_yin.catalyst_turn: [REDACTED: the target field]
...
- carry.catalyst: {"clause":"The knife has nothing to prune: skill idling without a project worth it.","remedy":"Pick one living ambition and start cutting."}
- carry.friction: {"clause":"The pruning never stops: forests of projects, an edge worn on material that never ends.","remedy":"Cut fewer branches, and finish them."}
...
- carry.missing: {"clause":"No material to cut: skill with nothing to work, an edge kept for its own sake.","remedy":"Borrow material: one project, one claim."}
- carry.spared: {"clause":"Wood runs absent, and the knife is not worn: nothing to prune, nothing to hold.","remedy":"Keep the knife bright. Pick projects rarely."}
- carry.thin: {"clause":"Wood runs thin and unwanted: a small plot, easily kept.","remedy":"Keep the plot small."}
...
- carry_yin.catalyst: [REDACTED: the target field]
- carry_yin.friction: {"clause":"The cutting never stops: trays of half-set stones, a facet worn on material that never ends.","remedy":"Cut fewer stones, and finish them."}
- carry_yin.wide: [REDACTED: the target field]

The classical excess idiom for this cell (say it in English in carry.excess, never quote it): 金能克木，木坚金缺 (克之不逮, the Action door).
...
Chart under test: contrast 辛 The Jewel, Overfueled, heavy Earth (fixture: Metal 20 / Earth 45 / Wood 15 / Fire 10 / Water 10). Band Overfueled. Wood runs 15%: catalyst, present; the state under test is catalyst.

## TASK

Write for 金_木, the yin sibling's variant: (a) mechanism_yin.catalyst_turn (≤35 words, opens "Run thin,"); (b) carry_yin.catalyst = {clause ≤18w, remedy ≤12w} CUT from that turn; (c) carry_yin.missing = {clause, remedy} for Wood wanted and absent; (d) carry_yin.wide = {clause, remedy} for Wood wanted and abundant or dominant, the plentiful line opening with one of the eight wide openers. Return {"catalyst_turn": "...", "carry": {"catalyst": {...}, "missing": {...}, "wide": {...}}} only.

Output shape: {"catalyst_turn": "...", "carry": {"catalyst": {"clause","remedy"}, "missing": {...}, "wide": {...}}}
