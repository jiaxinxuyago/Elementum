# BLIND GENERATION TEST · STEM_BAND.yourNature_desc+self_card · gui_open · open
...
Stem 癸 The Rain, Yin Water. Spine: permeates. Arena: Water (depth, current, tide, rain, spring, flow).
Angle Map row: | 癸 The Rain | Porousness: absorbing everything, losing the border of self | weather, rain, ground, seep, roots, the green after | soft accumulating clauses, edges dissolving |
Angle not to borrow: not depletion or unrecognised giving, that is 丙's and 己's.
Band: open = Underfueled (the core burns more than it takes in: the material running low or held back, never a portrait of giving away).
- manifesto: "Felt before spoken · You are the Water that quietly changes whatever it touches."
- dm_overview (the sign whose central image sentence 1 must receive): "The Rain is Yin Water, the last sign in the count, the water that closes the circle so it can begin again. It is rain, dew, and mist, the moisture that arrives everywhere and forces nothing. At winter's end it falls softly on planted fields through the night. By morning it is gone, and everything it touched has quietly agreed to grow."
- yourNature_desc (baseline, band-neutral, for the person's trait): "You feel what a day is carrying before anyone says so, and you take it in the way ground takes rain. Most of it grows something. Some of it was never yours to hold, and telling the difference is the quiet work of your life."

## TASK

Write {"yourNature_desc": "...", "self_card": {"face": "...", "presence": "..."}} for 癸 The Rain on the Underfueled band: yourNature_desc 50–75 words opening on "You" and receiving the sign's image in sentence 1; face ≤8 words; presence ≤30 words.
