# BLIND GENERATION TEST · ELEMENT_PAIR.function.definition · 金_水 · catalyst
...
**`ELEMENT_PAIR.function.definition_catalyst`** · **`ELEMENT_PAIR.function.definition_catalyst` / `definition_friction`** · energy page hero, role-resolved · reading (the B1–B2 zone) · second person · ≤55 words each · LOCKED ×25
...
- function.definition_catalyst: [REDACTED: the target field]
...
Chart under test: golden 庚 The Blade, 1995-04-29 18:00 Beijing (Overfueled; Earth 33 / Wood 33 / Metal 23 / Water 6 / Fire 5). Band Overfueled. Water runs 6%: catalyst, thin; the state under test is catalyst.

## TASK

Write function.definition_catalyst for 金_水 as {"definition_catalyst": "..."}: ≤55 words, second person, opening with the formula "Water is your Expression, and as a catalyst, it is …", then a concrete-life inventory of what the function does when it runs right.

Output shape: {"definition_catalyst": "..."}
