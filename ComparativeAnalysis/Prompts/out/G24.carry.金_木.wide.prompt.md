# BLIND GENERATION TEST · ELEMENT_PAIR.carry.pole · 金_木 · catalyst · wide
...
Chart under test: golden 庚 The Blade, 1995-04-29 18:00 Beijing (Overfueled; Earth 33 / Wood 33 / Metal 23 / Water 6 / Fire 5). Band Overfueled. Wood runs 33%: catalyst, abundant; the state under test is wide.

## TASK

Write carry.wide for 金_木 as {"wide": {"clause": "...", "remedy": "..."}}: clause ≤18 words that stands alone, remedy ≤12 words that is a plain directive. State: Wood wanted and abundant or dominant: the plentiful line, opening with one of the eight wide openers, no door metaphor, the remedy tells the reader to use it.

Output shape: {"wide": {"clause": "...", "remedy": "..."}}
