# BLIND GENERATION TEST · POSITION.health_line · jiecai_hour_branch
...
Named event: "The Rival inside the Hour Gate" · 劫财在时支. Persona The Rival (劫财). Definition line: "Same nature, different register, the edge of comparison". Keyword Rivalry, charge fierce, poles catalyst Daring / friction Drain. Family function: Body. Cost dimension: comparison as fuel; the race never announces a finish. Arena: the race, the shared prize, the other runner. Classical portrait: same nature, different register; comparison as fuel; the race with no announced finish. Ruled domains: Rivalry, Shared stakes, Boldness. Sibling (other polarity of the family): 比肩.
Gate: Hour Gate (ground: children, output, late life). Slot kind: branch (branch = the root, private, dispositional, "inside the Gate"). Era: the Late Chapter (48+). Relations register: children, students, heirs. Seat rank: fourth of seven (时支). Declared domains: ["Family","Wealth"].
...
Write health_line for jiecai_hour_branch as {"health_line": "..."}: ≤30 words, wellness register, non-medical: the seat's body correspondence in gentle tendency language; never a symptom assigned as fact, never a diagnosis.
