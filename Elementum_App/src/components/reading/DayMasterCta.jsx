// ===================================================================
// ELEMENTUM · DayMasterCta
// ===================================================================
// The "Read your Day Master" catalogue affordance (screens-v2 §5E) —
// the central seal's reading as an explicit tappable card. Shared by
// the at-rest EnergyCatalogue AND the RevealDissolve ceremony's final
// frame so both compositions are pixel-identical: the card must fade
// in WITH the shelf hint during the reveal, never pop in over it when
// the ceremony hands off to the real catalogue route.
// ===================================================================

export default function DayMasterCta({ dayMaster, glyph, archetype, onSeal }) {
  return (
    <button
      type="button"
      onClick={onSeal}
