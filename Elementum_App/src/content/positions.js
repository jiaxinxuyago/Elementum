...
// EVENTS: "The Alchemist inside the Career Gate · 偏印在月支". Every
...
export const POSITION_READINGS = {
  ...
  bijian_year_branch: {
    ...
    defline: 'The Twin lives inside your Origin Gate: the root of your early world was learning to hold your own.',
  ...
  bijian_hour_stem: {
    ...
    defline: 'The Twin stands at your Legacy Gate: what you show the future is independence, taught by demonstration.',
  ...
  jiecai_month_stem: {
    domains: ['Career', 'Social'],
    defline: 'At your Career Gate stands the daring colleague: the working world sees your nerve first.',
  ...
  jiecai_month_branch: {
    ...
    defline: 'Inside your Career Gate runs the gambler’s current: your prime years are built for bold, shared ventures.',
  ...
  shishen_year_stem: {
    ...
    defline: 'The Artisan stands at your Origin Gate: ease and charm are the first things your story shows.',
  ...
  shishen_year_branch: {
    ...
    defline: 'The Artisan lives inside your Origin Gate: the root of your early world was nourishment, given and remembered.',
  ...
  shishen_month_stem: {
    domains: ['Career', 'Social'],
    defline: 'The Artisan stands at your Career Gate: the working world sees the maker, gracious and unhurried.',
  ...
  shishen_hour_branch: {
    domains: ['Family', 'Health'],
    defline: 'The Artisan lives inside your Legacy Gate: your harvest is children, comfort, and a well-fed old age.',
  ...
  shangguan_year_branch: {
    domains: ['Family', 'Growth'],
    defline: 'Brilliance lives inside your Origin Gate: you were rooted in a house that talent had to outgrow.',
  ...
  shangguan_hour_stem: {
    domains: ['Career', 'Growth'],
    defline: 'Brilliance stands at your Legacy Gate: your later years intend to be seen, and heard.',
  ...
  shangguan_hour_branch: {
    domains: ['Family', 'Mind'],
    defline: 'Brilliance lives inside your Legacy Gate: the root of your harvest is a mind that never retires.',
  ...
  zhengcai_month_stem: {
    domains: ['Career', 'Wealth'],
    defline: 'The Steward stands at your Career Gate: the working world sees the safe pair of hands.',
  ...
  qisha_year_stem: {
    ...
    defline: 'The General stands at your Origin Gate: the world’s first read of you is force.',
  ...
  qisha_year_branch: {
    ...
    defline: 'The General lives inside your Origin Gate: your root was forged, not furnished.',
  ...
  qisha_month_stem: {
    domains: ['Career', 'Social'],
    defline: 'The General stands at your Career Gate: the working world sees command presence and expects orders.',
  ...
  qisha_hour_branch: {
    ...
    defline: 'The General lives inside your Legacy Gate: the root of your harvest is strength, held to the last.',
  ...
  zhengguan_year_branch: {
    domains: ['Family', 'Growth'],
    defline: 'Order lives inside your Origin Gate: your root is a rulebook, learned before you could read it.',
  ...
  zhengguan_month_stem: {
    domains: ['Career', 'Social'],
    defline: 'Order stands at your Career Gate: the working world sees an officer, promotable on sight.',
  ...
  zhengguan_hour_stem: {
    ...
    defline: 'Order stands at your Legacy Gate: what you show the future is standards, upheld to the end.',
  ...
  zhengguan_hour_branch: {
    domains: ['Family', 'Growth'],
    defline: 'Order lives inside your Legacy Gate: the root of your harvest is a life that kept its word.',
  ...
  pianyin_year_stem: {
    domains: ['Mind', 'Social'],
    defline: 'The Alchemist stands at your Origin Gate: the world’s first read of you is depth, slightly apart.',
  ...
  pianyin_year_branch: {
    ...
    defline: 'The Alchemist lives inside your Origin Gate: your root drinks from an odd, deep well.',
  ...
  pianyin_month_stem: {
    domains: ['Career', 'Mind'],
    defline: 'The Alchemist stands at your Career Gate: the working world sees the specialist it does not quite understand.',
  ...
  pianyin_hour_stem: {
    domains: ['Mind', 'Growth', 'Career'],
    defline: 'The Alchemist stands at your Legacy Gate: your later output turns inward, and finer.',
  ...
  pianyin_hour_branch: {
    domains: ['Family', 'Mind', 'Growth'],
    defline: 'The Alchemist lives inside your Legacy Gate: the root of your harvest is understanding, finally ripe.',
  ...
  zhengyin_year_stem: {
    domains: ['Family', 'Mind'],
    defline: 'Care stands at your Origin Gate: the first thing your story shows is that you were well held.',
  ...
  zhengyin_year_branch: {
    domains: ['Family', 'Growth', 'Health'],
    defline: 'Care lives inside your Origin Gate: your root is shelter itself, deep and possibly too warm.',
