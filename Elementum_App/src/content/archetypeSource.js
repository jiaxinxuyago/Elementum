...
There's also a specific interpersonal cost: people who care about you often feel like they're perpetually catching up. You don't mean to move that fast. You just can't stop.` },
  ...
  "丁": {
    ...
    gifts: [
      ...
      { phrase: `Misses nothing`, door: 'mind', face: 'wide', desc: `With this much fuel behind the flame, the small tell, the changed tone, the detail everyone walked past all catch your eye. You usually know why before anyone explains.` },
...
There's also a slow accumulation of unspoken costs. You absorb a great deal without naming it. Over time this produces weight no one sees — because you never showed it — which means no one thought to ask whether you were okay.` },
  ...
  "己": {
    ...
    shadows: [
      ...
      { phrase: `Stuck in your ways`, door: 'body', face: 'excess', desc: `So much settled ground that nothing new can take root. The plan that worked once is still the plan, and the fresh idea never gets past the doorway.` },
