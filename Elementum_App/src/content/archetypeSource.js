...
export const STEM_CARD_DATA = {
  ...
  "甲": {
    ...
    gifts: [
      { phrase: `Quick to start`, door: 'body', face: 'echo', desc: `The will to start is your reserve. When it is full you begin things before anyone has finished worrying, and when it dips you feel flat before you feel tired.` },
      { phrase: `Holds its ground`, door: 'body', face: 'wide', desc: `Wind from every side, and you are still where you were planted, still facing the same way. Plenty of growing force, and all of it rooted.` },
      { phrase: `Takes the lesson`, door: 'mind', face: 'echo', desc: `One hard season teaches you what a decade of easy ones could not. It goes in quietly, over reading and long talks and rest, and you keep it.` },
      { phrase: `Grows on rest`, door: 'mind', face: 'wide', desc: `Give you water and you grow. A quiet week, a long book, and the reaching starts again on its own.` },
      { phrase: `Owns the stage`, door: 'expression', face: 'echo', desc: `Put your name on the work and the whole table aims higher. Your reach, once visible, becomes the new ceiling, and nobody remembers deciding that.` },
      { phrase: `Makes it real`, door: 'action', face: 'echo', desc: `Ambition lands somewhere real with you. The idea becomes a lease, a title, a name on the door, while other people are still describing theirs.` },
      { phrase: `Sharpened by review`, door: 'order', face: 'echo', desc: `You grow fastest under exacting eyes. Give you an editor, a coach, a rule you chose, and the work comes back sharper every round.` },
    ],
    shadows: [
      { phrase: `Starts five things`, door: 'body', face: 'echo', desc: `More growing force than your life has outlets for. Restless, overcommitted, five things begun just to spend the energy, and none of them finished.` },
      { phrase: `Crowds everyone out`, door: 'body', face: 'excess', desc: `Growth so dense no other light gets in. The people around you stop growing in your shade, and one day you notice you have too.` },
      { phrase: `Waits for signs`, door: 'mind', face: 'echo', desc: `The move is ready. You are waiting for one more piece of advice before you make it, and the waiting has started to look like thinking.` },
...
There's also a specific interpersonal cost: people who care about you often feel like they're perpetually catching up. You don't mean to move that fast. You just can't stop.` },
  ...
  "乙": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Starts over easily`, door: 'body', face: 'echo', desc: `Cut back to nothing in March, and by June there is a green line up the wall again. The will to start is your reserve, and it refills.` },
      { phrase: `Thrives on little`, door: 'body', face: 'wide', desc: `Give you a wall, any wall, and by summer there is green on it. Plenty of growing force, and it never waits for ideal conditions.` },
      { phrase: `Remembers the route`, door: 'mind', face: 'echo', desc: `Every wall you have climbed is a map you keep. It goes in quietly, over rest and long conversations, and the second time is never the long way.` },
      { phrase: `Nobody's fool`, door: 'mind', face: 'wide', desc: `Years of quiet taking-in, and now you clock the difference between what is said and what is meant almost instantly. People stopped managing you long ago.` },
      { phrase: `Wins people over`, door: 'expression', face: 'echo', desc: `Not loudly, and not fast. But put your name on the work and give it a season, and the skeptics are asking your opinion first.` },
      { phrase: `Settles in`, door: 'action', face: 'echo', desc: `Where you arrive, you stay. The job, the flat, the friendship you climbed toward becomes something held, and it holds you back.` },
      { phrase: `Thrives on feedback`, door: 'order', face: 'echo', desc: `Cut back by the right hands, you come back stronger. An editor, a coach, a rule you chose, and the vine climbs straighter.` },
    ],
    shadows: [
      { phrase: `Tangled in others`, door: 'body', face: 'echo', desc: `More growing force than your life has outlets for, so it wraps around people. Pulling free now would take them down too.` },
      { phrase: `Grows over others`, door: 'body', face: 'excess', desc: `Given a shared wall, you take the sunny side without noticing. Growth so dense no other light gets in, and later you wonder why the other vine went quiet.` },
      { phrase: `Loses the thread`, door: 'mind', face: 'echo', desc: `One more opinion, one more book, and the winding forgets where it was going. Reflection has turned into stalling.` },
      ...
      { phrase: `Can't say no`, door: 'action', face: 'echo', desc: `A gap is a gap. You grow into all of them, hold all of them, and the garden has no space left for anything else.` },
  ...
  "丙": {
    ...
    identity: {
      ...
      overview:       `The Sun is Yang Fire, the fire that no one lit and no one owns. It keeps high summer and full noon, opening every market and warming every back without asking a single name. The sky itself is its lantern. Everything that grows turns toward it, and on the day it slips behind clouds, the whole village looks up and wonders.`,
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Lifts the morning`, door: 'body', face: 'echo', desc: `Your energy is the lift that makes mornings possible, for you and for the people near you. It runs in bursts, and the bursts are bright.` },
      { phrase: `Generous with warmth`, door: 'body', face: 'wide', desc: `Plenty of light and no meter on it. Everyone in the building gets some, whether they asked or not.` },
      { phrase: `Learns from everyone`, door: 'mind', face: 'echo', desc: `Skills stacked, books finished, friends kept for years. What you gather quietly is what you later spend as brilliance.` },
      { phrase: `Full of ideas`, door: 'mind', face: 'wide', desc: `With this much fuel around you, the light never wants for something to burn. Ideas, people, plans, all of it catches.` },
      { phrase: `Starts traditions`, door: 'expression', face: 'echo', desc: `The dinner you hosted once is now the dinner everyone hosts. What you warm tends to set into something people keep doing after you have moved on.` },
      { phrase: `Takes hard jobs`, door: 'action', face: 'echo', desc: `Easy work makes you careless. Hand you the negotiation nobody wants or the client everyone dreads, and the heat finally has something worth working on.` },
  ...
  "丁": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Fully committed`, door: 'body', face: 'echo', desc: `What you choose gets all the energy you have, in bursts, at close range. The people inside your circle never wonder where they stand.` },
      { phrase: `Deeply present`, door: 'body', face: 'wide', desc: `Plenty of light and all of it pointed at one person. Phones stay dark, time goes quiet, and they leave feeling seen in a way that is hard to find.` },
      { phrase: `Studies one thing`, door: 'mind', face: 'echo', desc: `One subject, years deep, stacked quietly like fuel. You know it the way people know a face, and it burns later as brilliance.` },
      { phrase: `Spots the detail`, door: 'mind', face: 'wide', desc: `With this much fuel behind the flame, the small tell, the changed tone, the detail everyone walked past all catch your eye. You usually know why before anyone explains.` },
      { phrase: `Rekindles people`, door: 'expression', face: 'echo', desc: `Your belief in someone works at close range and lasts. What you give a friend over one evening, a push, a plan, a way to see it, is still holding them up a year later.` },
      { phrase: `Cracks hard problems`, door: 'action', face: 'echo', desc: `Easy work wastes you. Give you one difficult, valuable thing within arm's reach and the heat finally has something to work on.` },
...
There's also an investment asymmetry that accumulates: you give the full quality of your attention without always checking whether it's being matched. The care is real. The return is often lower than what was given. And because the giving felt like connection rather than cost, the imbalance often goes unnamed for a long time.` },
  ...
  "戊": {
    ...
    identity: {
      ...
      overview:       `The Mountain is Yang Earth, the ground raised up until it touches weather. It was here before the roads and will be here after them, the wall that rivers learn to walk around. Travelers set their course by it and never ask how it is doing. It carries snow on its shoulders and the sky's own weight, and it calls the arrangement fair.`,
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Everyone's rock`, door: 'body', face: 'echo', desc: `The physical calm under everything else. Friends plan around you the way builders plan around bedrock, and it only erodes under skipped meals and moved bedtimes.` },
      { phrase: `Shows up regardless`, door: 'body', face: 'wide', desc: `Storms, funerals, moving days, the long boring middle of hard times. Plenty of steadiness, and you are still there in week six.` },
      { phrase: `Learns from people`, door: 'mind', face: 'echo', desc: `Cold text slides off. What warmed you stays: the person who showed you, the evening it was said, the praise that made it stick.` },
      { phrase: `Keeps the record`, door: 'mind', face: 'wide', desc: `So much has warmed its way in that you remember what was said, when, and by whom. Not to use it. Because it happened.` },
      { phrase: `Says it once`, door: 'expression', face: 'echo', desc: `You say the thing one time, plainly, the exact word, and do not repeat it. People learn to listen the first time.` },
      { phrase: `Safe hands`, door: 'action', face: 'echo', desc: `Money, chances, people in motion all need somewhere reliable to land. You profit by being the still point in a moving system.` },
      { phrase: `Carries the family`, door: 'order', face: 'echo', desc: `Family, teams, the people who grow back each season and ask you to grow with them. Care is your discipline, and it keeps you moving.` },
    ],
    shadows: [
      { phrase: `Sinks into routine`, door: 'body', face: 'echo', desc: `Heaviness accumulating. Routines hardened into ruts, comfort eaten past comfort, a body built for staying that now resists moving.` },
      { phrase: `Can't let go`, door: 'body', face: 'excess', desc: `So much steadiness nothing new can root. Jobs, grudges, houses, roles that ended years ago, all still held, because letting go feels like betraying everyone who leaned on the holding.` },
      { phrase: `Feeds on distraction`, door: 'mind', face: 'echo', desc: `Company, praise, a good evening, the feed on your phone: all of it feels like taking something in. By morning the ground knows nothing it did not know before.` },
      { phrase: `Hard to persuade`, door: 'mind', face: 'excess', desc: `Baked hard by too much heat. Once your footing is chosen, argument works on you in centuries, not conversations, and people stop bringing the map.` },
      ...
      { phrase: `Micromanages`, door: 'action', face: 'echo', desc: `Accounts checked daily, opportunities tracked past usefulness, control spending the calm it was meant to protect.` },
...
There's also a slow accumulation of unspoken costs. You absorb a great deal without naming it. Over time this produces weight no one sees — because you never showed it — which means no one thought to ask whether you were okay.` },
  ...
  "己": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Restful company`, door: 'body', face: 'echo', desc: `Nobody performs around you. The physical calm under everything lets friends unclench, say the true version, and stay an hour longer than they planned.` },
      { phrase: `Quietly essential`, door: 'body', face: 'wide', desc: `Plenty of ground and none of it announces itself. When you step back for a while, everything wilts a little, and everyone finally notices who was watering.` },
      { phrase: `Never forgets a kindness`, door: 'mind', face: 'echo', desc: `Affection, praise and festivity all count as study for you. You learn best from people who were warm while they taught, and you never forget them.` },
      { phrase: `Perfect timing`, door: 'mind', face: 'wide', desc: `With this much warmth in the ground, you know when to plant and when to leave it alone. Timing is the thing you never explain.` },
      { phrase: `Every word counts`, door: 'expression', face: 'echo', desc: `You speak rarely and it lands. The exact word, the finished piece, the standard people quote after you leave.` },
      { phrase: `Feeds the table`, door: 'action', face: 'echo', desc: `There is always enough. Money, chances, people in motion pass through your steady hands, and nobody asks how it was there before they were hungry.` },
      { phrase: `Keeps every promise`, door: 'order', face: 'echo', desc: `Your care does not have seasons of convenience. What you said in spring still stands in winter, and people build their lives on that.` },
    ],
    shadows: [
      { phrase: `Bogged down`, door: 'body', face: 'echo', desc: `Heaviness accumulating. Everything anyone drops goes into you and nothing drains out, and the field that grew things is turning to mud.` },
      { phrase: `Resists change`, door: 'body', face: 'excess', desc: `So much settled ground that nothing new can take root. The plan that worked once is still the plan, and the fresh idea never gets past the doorway.` },
      { phrase: `Lives on praise`, door: 'mind', face: 'echo', desc: `Praise, sparks, novelty taken in all day while real understanding stays shallow. The warmth is spending you, and it feels like learning.` },
      { phrase: `Busy but barren`, door: 'mind', face: 'excess', desc: `Baked hard by too much heat. Busy, warm, and producing nothing you wanted.` },
      ...
      { phrase: `Penny-watcher`, door: 'action', face: 'echo', desc: `Accounts checked daily, favors tracked, every flow managed past usefulness. The control spends the calm it was meant to protect.` },
  ...
  "庚": {
    ...
    gifts: [
      { phrase: `Never looks tired`, door: 'body', face: 'echo', desc: `You keep your shape long after the fuel is low. Nobody sees you run down, because the line stays straight while it happens.` },
      { phrase: `Finishes properly`, door: 'body', face: 'wide', desc: `You take longer to call something done, and it shows. What leaves your hands doesn't come back for fixing.` },
      ...
      { phrase: `Plays the long game`, door: 'action', face: 'echo', desc: `You cut so the thing can grow. What you plant and keep cutting back, money, skill, trust, comes back with interest because you never let it sprawl.` },
    ...
    shadows: [
      { phrase: `Tense all over`, door: 'body', face: 'echo', desc: `Discipline with nothing to spend itself on turns into tension. It lives in your shoulders and your jaw, and people read it before you speak.` },
      { phrase: `Never reconsiders`, door: 'body', face: 'excess', desc: `Once you have decided what something is, it stays that way. The person who grew, the plan that improved, the second chance that was earned, they all arrive at a door already shut.` },
      ...
      { phrase: `Overprepared`, door: 'mind', face: 'excess', desc: `Fed past use, the edge stalls. Everything goes in and nothing comes out, and the brooding gets mistaken for depth.` },
      { phrase: `No filter`, door: 'expression', face: 'echo', desc: `Talent with no banks runs into snacks, scrolling, remarks that cut deeper than you meant, and half-made things. Nothing is wrong, exactly. That is the problem.` },
      { phrase: `Spins its wheels`, door: 'action', face: 'echo', desc: `Effort goes wherever the branches already point: old ground held too hard, new shoots started too freely. The season ends with plenty of motion and nothing brought in.` },
...
The verdict also becomes load-bearing: once formed, it requires new information to pass through the same evaluative system that produced the original conclusion — a system that is very good at finding reasons why the new information doesn't change anything. You can hold a position longer than the evidence warrants, and some part of you knows it.`,
  ...
  "辛": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Steady under strain`, door: 'body', face: 'echo', desc: `Handled by everyone, changed by no one. You hold your form long after the fuel is low, so you notice you are tired late.` },
      { phrase: `Polished by default`, door: 'body', face: 'wide', desc: `Plenty of the material and all of it finished. Even the things nobody will see leave your hands done properly.` },
      { phrase: `Impeccable taste`, door: 'mind', face: 'echo', desc: `Years of quiet looking went in first. Now you know the good one from the almost-good one at a glance, and friends borrow your eye before they buy.` },
      { phrase: `Spots the crack`, door: 'mind', face: 'wide', desc: `With this much ground under the stone, you saw the flaw three months before it became the problem. You say it out loud exactly once, and then wait.` },
      { phrase: `Understated excellence`, door: 'expression', face: 'echo', desc: `What is inside moves outward without forcing. You do not advertise, compete, or explain. The work speaks quietly, and the people who know, know.` },
      { phrase: `Prices it right`, door: 'action', face: 'echo', desc: `You know what a thing is worth and where it belongs, and what you place keeps growing in value after you have placed it.` },
      { phrase: `Built to last`, door: 'order', face: 'echo', desc: `Pressure organizes you instead of scattering you. Nothing leaves your hands that you do not believe in, and years later your work is the one still holding up under inspection.` },
    ],
    shadows: [
      { phrase: `Polishes forever`, door: 'body', face: 'echo', desc: `Discipline with no outlet turns on the work. The tenth revision was ready. So was the sixth. The deadline passed while you fixed a flaw nobody else will ever perceive.` },
      { phrase: `Trusts one judge`, door: 'body', face: 'excess', desc: `So much certainty it cuts everything the same way. The only opinion that counts on your work is yours, and it has never once been satisfied.` },
      { phrase: `Never stops preparing`, door: 'mind', face: 'echo', desc: `One more course on the craft before the first stone is cut. The preparation is exquisite, and it has quietly replaced the work.` },
      { phrase: `Buried talent`, door: 'mind', face: 'excess', desc: `Kept safe for so long that nobody has seen the stone. The setting became the shelter, and the shelter became the box.` },
      { phrase: `Sharp tongue`, door: 'expression', face: 'echo', desc: `Output with no banks. The remark was accurate and it was small, and it went in deeper than you meant. You forgot it by dinner. They did not.` },
      { phrase: `Hoarder of starts`, door: 'action', face: 'echo', desc: `Every good piece deserves a setting, so you keep buying stones for settings you never make. Plenty of motion, nothing finished.` },
  ...
  "壬": {
    ...
    identity: {
      ...
      overview:       `The Ocean is Yang Water, the water that never learned the meaning of far. Early winter is its season, pulling everything down into depth and moving on under a still surface. It is the open sea and the long river, the current that crosses what the eye gives up on. Past the harbor mouth it keeps its own maps.`,
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Recharges in silence`, door: 'body', face: 'echo', desc: `The reserve under everything you notice refills in stillness. Noise and company drain it long before you feel tired, and one quiet evening brings it back.` },
      { phrase: `Deep calm`, door: 'body', face: 'wide', desc: `Plenty of depth. Storms cross the surface, and ten fathoms down nothing has moved.` },
      { phrase: `Learns from experts`, door: 'mind', face: 'echo', desc: `Vague knowing becomes usable the moment someone exact gets hold of it. A rigorous teacher, a clean method, and the depth finally has a shape to pour through.` },
      { phrase: `Strategic mind`, door: 'mind', face: 'wide', desc: `Fed by exact sources, the depth has structure. While the meeting argues about one tile, you see the whole mosaic and where it is heading.` },
      { phrase: `Makes others grow`, door: 'expression', face: 'echo', desc: `You mention it once at dinner and walk away. A year later it is someone's company, and they are only half sure where it came from.` },
      { phrase: `Thinks big`, door: 'action', face: 'echo', desc: `Launches, markets, the moment that rewards whoever read it early. Small plans bore you, and you see the far shore clearly where others squint.` },
      { phrase: `Thrives on structure`, door: 'order', face: 'echo', desc: `Fixed roles, steady schedules, commitments that do not move with your moods. Inside walls you chose, the depth becomes force.` },
    ],
    shadows: [
      { phrase: `Stagnant`, door: 'body', face: 'echo', desc: `Stillness pooling into stagnation. Sleep that stretches without refreshing, energy waiting for a current that never comes.` },
      { phrase: `Closed book`, door: 'body', face: 'excess', desc: `So much depth that nothing surfaces. Even the people closest to you work from a fraction, and whole regions of you stay unmapped, never offered.` },
      { phrase: `Over-organized`, door: 'mind', face: 'echo', desc: `Systems perfected, methods collected, understanding organized so thoroughly it never gets used. The structure is displacing the thinking.` },
      { phrase: `Drowning in advice`, door: 'mind', face: 'excess', desc: `So much counsel has gone in that the water will not clear. You cannot see your own bottom anymore.` },
      { phrase: `Overgives`, door: 'expression', face: 'echo', desc: `Every person developed, every idea watered, your depth spent raising gardens you do not live in.` },
      { phrase: `Chases hot chances`, door: 'action', face: 'echo', desc: `Hot chances chased, quick pivots made, each one costing more recovery than it returns. Fast money is expensive for you.` },
      { phrase: `Carries every blame`, door: 'order', face: 'echo', desc: `A calendar with no slack, roles held from duty, and when you miss one the sternest voice you hear is your own. Quiet is not the same as calm.` },
    ],
    blocks: [
      {
        label: `How you experience the world`,
...
Most exchanges happen at a shallower level than where you operate. This produces a persistent sense of being encountered at the surface — of having depth no one is quite reaching. The response is often to withdraw further rather than simplify, which deepens the problem without resolving it.` },
  ...
  "癸": {
    ...
    identity: {
      ...
      overview:       `The Rain is Yin Water, the last sign in the count, the water that closes the circle so it can begin again. It is rain, dew, and mist, the moisture that arrives everywhere and forces nothing. At winter's end it falls softly on planted fields through the night. By morning it is gone, and everything it touched has quietly agreed to grow.`,
    ...
    gifts: [
      ...
      { phrase: `Ahead of the curve`, door: 'action', face: 'echo', desc: `You felt the turn before the numbers did. The launch, the offer, the door about to open: you were already there when the bright thing arrived.` },
      { phrase: `Blooms on routine`, door: 'order', face: 'echo', desc: `Fixed roles, steady schedules, commitments that do not move with your moods. Inside walls you chose, the rain becomes a river.` },
    ],
    shadows: [
      { phrase: `Waits to be moved`, door: 'body', face: 'echo', desc: `So much stillness that nothing moves. You wait for a current to carry you instead of choosing one, and the waiting looks like rest but leaves you flat.` },
      { phrase: `Carries others' feelings`, door: 'body', face: 'excess', desc: `So much felt that nothing surfaces to be checked. Their weather becomes yours, and by evening you cannot say whose sadness you are carrying.` },
      { phrase: `Replays every word`, door: 'mind', face: 'echo', desc: `The conversation ended Tuesday and you are still in it Friday, sorting the tone and the pause into a system that never gets used.` },
      { phrase: `Soaks up everything`, door: 'mind', face: 'excess', desc: `Too much taken in and the water will not clear. You walk in fine and leave carrying the argument two strangers had near you.` },
      { phrase: `Everyone's helper`, door: 'expression', face: 'echo', desc: `Every stalled person and every half idea gets your rain. You leave greener ground behind you everywhere, and none of it is yours.` },
      { phrase: `Quick to bite`, door: 'action', face: 'echo', desc: `Every warm thing pulls you toward it, and you rise to meet it before anything lands. Each bright chance costs more recovery than it returns.` },
      { phrase: `Self-punishing`, door: 'order', face: 'echo', desc: `Roles held from duty long after they stopped fitting, and one missed duty brings the sternest voice you hear, your own, so softly that nobody else notices.` },
    ],
    blocks: [
      {
        label: `How you experience the world`,
