...
export const STEM_CARD_DATA = {
  ...
  "甲": {
    ...
    gifts: [
      ...
      { phrase: `Raises everyone's game`, door: 'expression', face: 'echo', desc: `Put your name on the work and the whole table aims higher. Your reach, once visible, becomes the new ceiling, and nobody remembers deciding that.` },
      { phrase: `Makes it official`, door: 'action', face: 'echo', desc: `Ambition lands somewhere real with you. The idea becomes a lease, a title, a name on the door, while other people are still describing theirs.` },
      { phrase: `Better when edited`, door: 'order', face: 'echo', desc: `You grow fastest under exacting eyes. Give you an editor, a coach, a rule you chose, and the work comes back sharper every round.` },
    ],
    shadows: [
...
There's also a specific interpersonal cost: people who care about you often feel like they're perpetually catching up. You don't mean to move that fast. You just can't stop.` },
  ...
  "乙": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Regrows from little`, door: 'body', face: 'echo', desc: `Cut back to nothing in March, and by June there is a green line up the wall again. The will to start is your reserve, and it refills.` },
      { phrase: `Grows anywhere`, door: 'body', face: 'wide', desc: `Give you a wall, any wall, and by summer there is green on it. Plenty of growing force, and it never waits for ideal conditions.` },
      { phrase: `Maps the wall`, door: 'mind', face: 'echo', desc: `Every wall you have climbed is a map you keep. It goes in quietly, over rest and long conversations, and the second time is never the long way.` },
      ...
      { phrase: `Better for pruning`, door: 'order', face: 'echo', desc: `Cut back by the right hands, you come back stronger. An editor, a coach, a rule you chose, and the vine climbs straighter.` },
    ],
    shadows: [
  ...
  "丙": {
    ...
    gifts: [
      ...
      { phrase: `Shines on everyone`, door: 'body', face: 'wide', desc: `Plenty of light and no meter on it. Everyone in the building gets some, whether they asked or not.` },
      ...
      { phrase: `Sleeps on it`, door: 'order', face: 'echo', desc: `Your best decisions all survived a night of doubt. One calm person, one cold look at the budget, and the leap lands.` },
    ],
    shadows: [
  ...
  "丁": {
    ...
    gifts: [
      ...
      { phrase: `Misses nothing`, door: 'mind', face: 'wide', desc: `With this much fuel behind the flame, the small tell, the changed tone, the detail everyone walked past all catch your eye. Three months later it turned out to be the whole story.` },
      { phrase: `Rekindles people`, door: 'expression', face: 'echo', desc: `Your belief in someone works at close range and lasts. A friend arrives half given up, and somewhere over tea at your table, the pilot light catches again.` },
...
There's also a slow accumulation of unspoken costs. You absorb a great deal without naming it. Over time this produces weight no one sees — because you never showed it — which means no one thought to ask whether you were okay.` },
  ...
  "己": {
    ...
    gifts: [
      ...
      { phrase: `Remembers who helped`, door: 'mind', face: 'echo', desc: `Affection, praise and festivity all count as study for you. You learn best from people who were warm while they taught, and you never forget them.` },
      { phrase: `Reads the season`, door: 'mind', face: 'wide', desc: `With this much warmth in the ground, you know when to plant and when to leave it alone. Timing is the thing you never explain.` },
      { phrase: `Few words, exact`, door: 'expression', face: 'echo', desc: `You speak rarely and it lands. The exact word, the finished piece, the standard people quote after you leave.` },
    ...
    shadows: [
      { phrase: `Takes the mud`, door: 'body', face: 'echo', desc: `Heaviness accumulating. Everything anyone drops goes into you and nothing drains out, and the field that grew things is turning to mud.` },
      { phrase: `Too agreeable`, door: 'body', face: 'excess', desc: `So much ground given over to everyone else that nothing of your own can root. The group picks the plan and you say it is fine. It is always fine.` },
      { phrase: `Overheats on praise`, door: 'mind', face: 'echo', desc: `Praise, sparks, novelty taken in all day while real understanding stays shallow. The warmth is spending you, and it feels like learning.` },
  ...
  "庚": {
    ...
    gifts: [
      ...
      { phrase: `Trims for growth`, door: 'action', face: 'echo', desc: `You cut so the thing can grow. What you plant and keep cutting back, money, skill, trust, comes back with interest because you never let it sprawl.` },
    ...
    shadows: [
      ...
      { phrase: `Plans, never acts`, door: 'mind', face: 'excess', desc: `Fed past use, the edge stalls. Everything goes in and nothing comes out, and the brooding gets mistaken for depth.` },
      ...
      { phrase: `Busy, nothing finished`, door: 'action', face: 'echo', desc: `Effort goes wherever the branches already point: old ground held too hard, new shoots started too freely. The season ends with plenty of motion and nothing brought in.` },
...
The verdict also becomes load-bearing: once formed, it requires new information to pass through the same evaluative system that produced the original conclusion — a system that is very good at finding reasons why the new information doesn't change anything. You can hold a position longer than the evidence warrants, and some part of you knows it.`,
  ...
  "辛": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Keeps its shape`, door: 'body', face: 'echo', desc: `Handled by everyone, changed by no one. You hold your form long after the fuel is low, so you notice you are tired late.` },
      ...
      { phrase: `Quality guaranteed`, door: 'order', face: 'echo', desc: `Pressure organizes you instead of scattering you. Nothing leaves your hands that you do not believe in, and years later your work is the one still holding up under inspection.` },
    ],
    shadows: [
  ...
  "壬": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Restored by quiet`, door: 'body', face: 'echo', desc: `The reserve under everything you notice refills in stillness. Noise and company drain it long before you feel tired, and one quiet evening brings it back.` },
      { phrase: `Nothing rattles it`, door: 'body', face: 'wide', desc: `Plenty of depth. Storms cross the surface, and ten fathoms down nothing has moved.` },
      ...
      { phrase: `Big picture thinker`, door: 'mind', face: 'wide', desc: `Fed by exact sources, the depth has structure. While the meeting argues about one tile, you see the whole mosaic and where it is heading.` },
      { phrase: `Gives ideas away`, door: 'expression', face: 'echo', desc: `You mention it once at dinner and walk away. A year later it is someone's company, and they are only half sure where it came from.` },
    ...
    shadows: [
      { phrase: `Rest stops working`, door: 'body', face: 'echo', desc: `Stillness pooling into stagnation. Sleep that stretches without refreshing, energy waiting for a current that never comes.` },
      { phrase: `Hard to know`, door: 'body', face: 'excess', desc: `So much depth that nothing surfaces. Even the people closest to you work from a fraction, and whole regions of you stay unmapped, never offered.` },
      { phrase: `Collects frameworks`, door: 'mind', face: 'echo', desc: `Systems perfected, methods collected, understanding organized so thoroughly it never gets used. The structure is displacing the thinking.` },
...
Most exchanges happen at a shallower level than where you operate. This produces a persistent sense of being encountered at the surface — of having depth no one is quite reaching. The response is often to withdraw further rather than simplify, which deepens the problem without resolving it.` },
  ...
  "癸": {
    ...
    // GIFTS & SHADOWS — band-tagged pools ×5 (REA_16 §3 pool laws); resolveArchetype selects the chart's ×3
    gifts: [
      { phrase: `Needs the quiet`, door: 'body', face: 'echo', desc: `Your reserve refills in stillness and drains through noise and company long before you feel tired. One quiet night and the dew is back.` },
      { phrase: `Gentle confidant`, door: 'body', face: 'wide', desc: `Plenty of depth, softly held. People hand you their fragile things, the secret, the shame, the half-formed hope, and you have never broken one.` },
      { phrase: `Better with structure`, door: 'mind', face: 'echo', desc: `Exact teachers, clean methods, rigorous tools turn what you feel into something usable. You think better with structure than with more input.` },
      { phrase: `Feels the undercurrent`, door: 'mind', face: 'wide', desc: `Fed by exact sources, the feel arrives early. You knew the couple was fighting before they did.` },
      { phrase: `Changes minds softly`, door: 'expression', face: 'echo', desc: `Nobody remembers losing the argument to you. Positions shift a degree a week until, months later, everyone agrees and thinks they always did.` },
      { phrase: `Spots the opening`, door: 'action', face: 'echo', desc: `You felt the turn before the numbers did. The launch, the offer, the door about to open: you were already there when the bright thing arrived.` },
    ...
    shadows: [
      { phrase: `Sleeps without rest`, door: 'body', face: 'echo', desc: `Stillness pooling into stagnation. Sleep that stretches without refreshing, feeling waiting for a current that never comes.` },
      { phrase: `Loses the border`, door: 'body', face: 'excess', desc: `So much felt that nothing surfaces to be checked. Their weather becomes yours, and by evening you cannot say whose sadness you are carrying.` },
