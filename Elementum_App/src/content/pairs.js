...
export const PAIR_CELLS = {
  ...
  '火_木': {
    ...
    carry: {
      ...
      spared: { clause: `Wood runs absent, and the fire is not smothered: nothing hoarded, nothing postponed.`, remedy: `Keep it. Gather only what you will burn.` },
      thin: { clause: `Wood runs thin and unwanted: a small pile, easily burned.`, remedy: `Burn it as it comes.` },
      excess: { clause: `Too much wood chokes the fire: fuel stacked past burning, the flame smothered by its own supply.`, remedy: `Pull a branch off. Strike.` },
    },
  },
  '火_火': {
    mechanism: {
