...
For the design rationale, content authoring rules, and the Phase 2 extraction roadmap, read the docs in `../Documents/` (especially Design/DES_03, Design/DES_04, Development/DEV_02) and the migration progress notes in `../Reference/README.md`.
