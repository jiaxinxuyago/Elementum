...
1. Drift check: docs changed in the last 48h (`git log --since=2.days --name-only -- DevLog_Docs/`) audited fully, PLUS always re-verify the automation-critical trio (DEV_03, PM_01, INF_01 — every path/command in them must work today).
