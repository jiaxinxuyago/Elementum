...
// ===================================================================
// Parses Reading/Documents/REA_03_Reading_Generation_Schema.md (canonical)
// and emits Reading/Database/REA_03_generation_schema.xlsx (the sortable twin).
...
const MD = path.resolve(__dirname, '../../Reading/Documents/REA_03_Reading_Generation_Schema.md');
const OUT = path.resolve(__dirname, '../../Reading/Database/REA_03_generation_schema.xlsx');
...
wb.creator = 'build-field-map-xlsx.mjs (generated from REA_03 markdown — the markdown is canonical)';
...
ws.addRow(['REA_03 — Reading Generation Schema · generated from Reading/Documents/REA_03_Reading_Generation_Schema.md — markdown is canonical, do not hand-edit']);
...
ws10.addRow(['Standing rules for template generation (REA_03 §10 — see the markdown for full text)']).font = { ...FONT, bold: true, size: 11 };
