...
T('tpl_section_teasers', 'LIVE (curation pass v2, owner 2026-08-19) — the element page teaser sentences, derived assembly (no authored corpus)', 'S1 clause + S2 = the pair turn\'s first sentence quoted', {
  ...
  core_line: 'No reaction here: {El} is the substance you are, doubled.',
  balanced_lines: { core: 'In your chart it holds its measure.', other: 'In your chart it runs balanced: nothing to force.' },
  dom_seat_clauses: { seated: '{it holds|they hold} {n} seat(s) in your pillars', unseated: '{it reaches|they reach} you through the hidden stems' },
});
