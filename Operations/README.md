...
| REA_13 | Concept_Dictionary | THE V BOOK — vocabulary law + naming registry + BaZi concept families + ALL locked terms (never a generation target) | REA_07 Pt 1 + REA_11 |
| REA_14 | Reading_Generation_Schema | THE A BOOK — archetype-varying data variables + templates + assembly model + §7 decision log (xlsx twin: `Reading/Database/REA_14_generation_schema.xlsx`, regen via `Elementum_App/tools/build-field-map-xlsx.mjs`) | REA_04 + REA_12 + REA_06 |
| REA_15 | Concept_Ladder | Teaching order (ladder L1–L15) + section charters + teaching-status audit | REA_07 Pts 2–3 |
...
**V/A consolidation mapping (2026-07-28, owner-approved):** REA_04→REA_14 · REA_06→REA_14 · REA_07→REA_13 (law/registry/inventory) + REA_15 (ladder/charters) · REA_11→REA_13 · REA_12→REA_14. Retired REA numbers are never reused; legacy section citations resolve at the same § numbers in the new books (REA_07 §1–3 = REA_13 §1–3 · REA_11 §4–6 = REA_13 §4–6 · REA_04 §7 = REA_14 §7 · REA_07 §6–12 = REA_15 §6–12).
...
DOC1→DEV_01 · DOC2→DES_01→REA_01 · DOC3→DES_02→REA_02 · DOC4→DES_03→REA_03 · DOC5→DES_04 · DOC6→DES_05→REA_04→REA_14 · DOC7→DES_06→REA_05 · DOC8→DEV_02 · DOC9→DES_07→REA_06→REA_14 · DOC10→INF_01
