...
| REA_12 | Reading_Data_Field_Map | THE FIELD MAP — every journey data field: type, variant axis, measured length, budget, source of truth (xlsx twin: `Reading/Database/REA_12_field_map.xlsx`, regen via `Elementum_App/tools/build-field-map-xlsx.mjs`) | — |
