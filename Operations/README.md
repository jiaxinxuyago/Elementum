...
| REA_12 | Reading_Data_Variables | THE TEMPLATE SCHEMA — unique reading data variables (V/A/T/D classes × variant axis × budget), UI slots as pointers; operationalizes REA_04 at variable grain (xlsx twin: `Reading/Database/REA_12_reading_data_variables.xlsx`, regen via `Elementum_App/tools/build-field-map-xlsx.mjs`; formerly Reading_Data_Field_Map 2026-07-27) | — |
