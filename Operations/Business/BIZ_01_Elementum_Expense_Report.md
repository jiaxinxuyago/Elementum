...
Monthly budget report (automation piece #10, 1st of month) tracks this table + actuals; statement reconciliation is owner-fed CSV drops into `Operations/Business/statements/` (gitignored) — agents NEVER hold bank/financial credentials (standing rule).
